...
namespace agg
{
    ...
    public:
        ...
        const rasterizer_cells_aa<cell_aa>& outline() const { return m_outline; }
        ...
        //--------------------------------------------------------------------
        AGG_INLINE unsigned calculate_alpha(int area, bool smooth) const
        {
        ...
        //--------------------------------------------------------------------
        template<class Scanline> bool sweep_scanline(Scanline& sl, bool smooth=true)
        {
            for(;;)
            {
                ...
                while(num_cells)
                {
                    ...
                    if(area)
                    {
                        alpha = calculate_alpha((cover << (poly_subpixel_shift + 1)) - area, smooth);
                        if(alpha)
                        {
                            sl.add_cell(x, alpha);
                        }
                    ...
                    {
                        alpha = calculate_alpha(cover << (poly_subpixel_shift + 1), smooth);
                        if(alpha)
                        {
