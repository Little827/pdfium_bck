...
SlotSpanMetadata<thread_safe>::FromSlotStart(uintptr_t slot_start) {
  ...
  PA_DCHECK(!((::pdfium::base::internal::UnmaskPtr(slot_start) -
...
SlotSpanMetadata<thread_safe>::FromObject(void* object) {
  ...
  PA_DCHECK((::pdfium::base::internal::UnmaskPtr(object_addr) -
             ::pdfium::base::internal::UnmaskPtr(slot_span_start)) %
                slot_span->bucket->slot_size ==
...
PA_ALWAYS_INLINE void SlotSpanMetadata<thread_safe>::AppendFreeList(
  ...
  }
  {
    ...
    for (auto* entry = head; entry;
      ...
      uintptr_t unmasked_entry = ::pdfium::base::internal::UnmaskPtr(
...
using ::pdfium::base::internal::AllocationStateMap;
using ::pdfium::base::internal::CommittedStateBitmapSize;
using ::pdfium::base::internal::IterateSlotSpans;
using ::pdfium::base::internal::PartitionPage;
using ::pdfium::base::internal::PartitionSuperPageExtentEntry;
using ::pdfium::base::internal::PartitionSuperPageToExtent;
using ::pdfium::base::internal::PartitionSuperPageToMetadataArea;
using ::pdfium::base::internal::ReservedStateBitmapSize;
using ::pdfium::base::internal::SlotSpanMetadata;
using ::pdfium::base::internal::StateBitmapFromAddr;
using ::pdfium::base::internal::SuperPageStateBitmap;
using ::pdfium::base::internal::SuperPageStateBitmapAddr;
