...
#ifndef THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_PARTITION_LOCK_H_
#define THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_PARTITION_LOCK_H_
...
#include "third_party/base/allocator/partition_allocator/spinning_mutex.h"
...
using PartitionLock = ::pdfium::base::internal::Lock;
using PartitionAutoLock = ::pdfium::base::internal::ScopedGuard;

}  // namespace internal
}  // namespace base

#endif  // THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_PARTITION_LOCK_H_
