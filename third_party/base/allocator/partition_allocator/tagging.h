...
#ifndef THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_TAGGING_H_
#define THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_TAGGING_H_
...
#endif  // THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_TAGGING_H_
