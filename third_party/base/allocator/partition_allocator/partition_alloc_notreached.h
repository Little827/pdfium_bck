...
#ifndef THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_PARTITION_ALLOC_NOTREACHED_H_
#define THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_PARTITION_ALLOC_NOTREACHED_H_

#include "third_party/base/allocator/partition_allocator/logging_buildflags.h"
...
#define PA_NOTREACHED()                                                    \
  true ? ::pdfium::base::internal::logging::RawError(                      \
...
#define PA_NOTREACHED()                                               \
  PA_UNLIKELY(true)                                                   \
  ? ::pdfium::base::internal::logging::RawCheck(                      \
        __FILE__ "(" PA_STRINGIFY(__LINE__) ") PA_NOTREACHED() hit.") \
  : PA_EAT_CHECK_STREAM_PARAMS()
...
#endif  // THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_PARTITION_ALLOC_NOTREACHED_H_
