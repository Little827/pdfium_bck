...
#include "third_party/base/allocator/partition_allocator/arm_bti_test_functions.h"
...
size_t HugeMemoryAmount() {
  return std::max(::pdfium::base::internal::ASLRMask(),
                  std::size_t{2} * ::pdfium::base::internal::ASLRMask());
}
