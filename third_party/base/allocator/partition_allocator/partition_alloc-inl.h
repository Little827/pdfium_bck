...
#ifndef THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_PARTITION_ALLOC_INL_H_
#define THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_PARTITION_ALLOC_INL_H_
...
PA_ALWAYS_INLINE bool RandomPeriod() {
  ...
  if (PA_UNLIKELY(counter == 0)) {
    ...
    counter = static_cast<uint8_t>(::pdfium::base::internal::RandomValue());
  }
...
#endif  // THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_PARTITION_ALLOC_INL_H_
