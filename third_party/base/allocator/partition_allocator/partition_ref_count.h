...
#ifndef THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_PARTITION_REF_COUNT_H_
#define THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_PARTITION_REF_COUNT_H_
 ...
 public:
  ...
  PA_ALWAYS_INLINE bool Release() {
    ...
    if (PA_UNLIKELY((old_count & kDanglingRawPtrDetectedBit) ==
      ...
      pdfium::base::internal::DanglingRawPtrReleased(
  ...
  PA_ALWAYS_INLINE bool ReleaseFromAllocator() {
    ...
    if (PA_UNLIKELY(old_count & kPtrCountMask)) {
      ...
      pdfium::base::internal::DanglingRawPtrDetected(
          reinterpret_cast<uintptr_t>(this));
    }
...
PA_ALWAYS_INLINE PartitionRefCount* PartitionRefCountPointer(
  ...
  PA_DCHECK(slot_start == ::pdfium::base::internal::RemaskPtr(slot_start));
...
#endif  // THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_PARTITION_REF_COUNT_H_
