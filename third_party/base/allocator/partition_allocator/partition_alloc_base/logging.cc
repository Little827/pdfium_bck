...
#if defined(                                                                         \
    THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_PARTITION_ALLOC_BASE_CHECK_H_) || \
    defined(BASE_CHECK_H_) ||                                                        \
    defined(                                                                         \
        THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_PARTITION_ALLOC_CHECK_H_)
...
#include "third_party/base/allocator/partition_allocator/partition_alloc_base/debug/alias.h"
#include "third_party/base/allocator/partition_allocator/partition_alloc_base/posix/eintr_wrapper.h"

#if BUILDFLAG(IS_POSIX) || BUILDFLAG(IS_FUCHSIA)
#include "third_party/base/allocator/partition_allocator/partition_alloc_base/posix/safe_strerror.h"
#endif
