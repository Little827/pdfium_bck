...
#ifndef THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_PARTITION_ALLOC_BASE_THREADING_PLATFORM_THREAD_H_
#define THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_PARTITION_ALLOC_BASE_THREADING_PLATFORM_THREAD_H_
...
#include "third_party/base/allocator/partition_allocator/partition_alloc_base/threading/platform_thread_ref.h"
#include "third_party/base/allocator/partition_allocator/partition_alloc_base/time/time.h"

#if BUILDFLAG(IS_WIN)
#include "third_party/base/allocator/partition_allocator/partition_alloc_base/win/windows_types.h"
...
#endif  // THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_PARTITION_ALLOC_BASE_THREADING_PLATFORM_THREAD_H_
