...
#include "third_party/base/allocator/partition_allocator/partition_alloc_base/files/file_util.h"
...
int GetUrandomFD() {
  static pdfium::base::internal::base::NoDestructor<URandomFd> urandom_fd;
