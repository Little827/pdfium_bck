...
#ifndef THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_PARTITION_ALLOC_BASE_LOGGING_H_
#define THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_PARTITION_ALLOC_BASE_LOGGING_H_
...
#include "third_party/base/allocator/partition_allocator/partition_alloc_base/migration_adapter.h"
...
namespace pdfium::base::internal::logging {
...
#define PA_COMPACT_GOOGLE_LOG_EX_INFO(ClassName, ...)                      \
  ::pdfium::base::internal::logging::ClassName(                            \
      __FILE__, __LINE__, ::pdfium::base::internal::logging::LOGGING_INFO, \
      ##__VA_ARGS__)
#define PA_COMPACT_GOOGLE_LOG_EX_WARNING(ClassName, ...)                      \
  ::pdfium::base::internal::logging::ClassName(                               \
      __FILE__, __LINE__, ::pdfium::base::internal::logging::LOGGING_WARNING, \
      ##__VA_ARGS__)
#define PA_COMPACT_GOOGLE_LOG_EX_ERROR(ClassName, ...)                      \
  ::pdfium::base::internal::logging::ClassName(                             \
      __FILE__, __LINE__, ::pdfium::base::internal::logging::LOGGING_ERROR, \
      ##__VA_ARGS__)
#define PA_COMPACT_GOOGLE_LOG_EX_FATAL(ClassName, ...)                      \
  ::pdfium::base::internal::logging::ClassName(                             \
      __FILE__, __LINE__, ::pdfium::base::internal::logging::LOGGING_FATAL, \
      ##__VA_ARGS__)
#define PA_COMPACT_GOOGLE_LOG_EX_DFATAL(ClassName, ...)                      \
  ::pdfium::base::internal::logging::ClassName(                              \
      __FILE__, __LINE__, ::pdfium::base::internal::logging::LOGGING_DFATAL, \
      ##__VA_ARGS__)
#define PA_COMPACT_GOOGLE_LOG_EX_DCHECK(ClassName, ...)                      \
  ::pdfium::base::internal::logging::ClassName(                              \
      __FILE__, __LINE__, ::pdfium::base::internal::logging::LOGGING_DCHECK, \
      ##__VA_ARGS__)
...
#define PA_LOG_IS_ON(severity)                                \
  (::pdfium::base::internal::logging::ShouldCreateLogMessage( \
      ::pdfium::base::internal::logging::LOGGING_##severity))
...
#define PA_VLOG_IS_ON(verboselevel) \
  ((verboselevel) <= ::pdfium::base::internal::logging::GetVlogVerbosity())
...
#define PA_LAZY_STREAM(stream, condition) \
  !(condition)                            \
      ? (void)0                           \
      : ::pdfium::base::internal::logging::LogMessageVoidify() & (stream)
...
#define PA_VLOG_STREAM(verbose_level)                               \
  ::pdfium::base::internal::logging::LogMessage(__FILE__, __LINE__, \
                                                -(verbose_level))   \
      .stream()
...
#define PA_VPLOG_STREAM(verbose_level)                             \
  ::pdfium::base::internal::logging::Win32ErrorLogMessage(         \
      __FILE__, __LINE__, -(verbose_level),                        \
      ::pdfium::base::internal::logging::GetLastSystemErrorCode()) \
      .stream()
#elif BUILDFLAG(IS_POSIX) || BUILDFLAG(IS_FUCHSIA)
#define PA_VPLOG_STREAM(verbose_level)                             \
  ::pdfium::base::internal::logging::ErrnoLogMessage(              \
      __FILE__, __LINE__, -(verbose_level),                        \
      ::pdfium::base::internal::logging::GetLastSystemErrorCode()) \
      .stream()
#endif
...
#define PA_EAT_STREAM_PARAMETERS                                  \
  true ? (void)0                                                  \
       : ::pdfium::base::internal::logging::LogMessageVoidify() & \
             (*::pdfium::base::internal::logging::g_swallow_stream)
...
#define PA_RAW_LOG(level, message)           \
  ::pdfium::base::internal::logging::RawLog( \
      ::pdfium::base::internal::logging::LOGGING_##level, message)

}  // namespace pdfium::base::internal::logging

#endif  // THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_PARTITION_ALLOC_BASE_LOGGING_H_
