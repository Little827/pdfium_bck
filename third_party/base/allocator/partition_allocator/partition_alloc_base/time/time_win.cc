...
#include "third_party/base/allocator/partition_allocator/partition_alloc_base/bit_cast.h"
...
::pdfium::base::internal::Lock& GetHighResLock() {
  static ::pdfium::base::internal::Lock lock;
  return lock;
}
