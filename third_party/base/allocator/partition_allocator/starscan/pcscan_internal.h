...
#ifndef THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_STARSCAN_PCSCAN_INTERNAL_H_
#define THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_STARSCAN_PCSCAN_INTERNAL_H_
...
#include "third_party/base/allocator/partition_allocator/starscan/starscan_fwd.h"
#include "third_party/base/allocator/partition_allocator/starscan/write_protector.h"
...
class PCScanInternal final {
 public:
  ...
  void RegisterStatsReporter(pdfium::base::StatsReporter* reporter);
  pdfium::base::StatsReporter& GetReporter();
 ...
 private:
  ...
  pdfium::base::StatsReporter* stats_reporter_ = nullptr;
...
#endif  // THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_STARSCAN_PCSCAN_INTERNAL_H_
