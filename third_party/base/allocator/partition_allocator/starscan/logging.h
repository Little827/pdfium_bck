...
#ifndef THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_STARSCAN_LOGGING_H_
#define THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_STARSCAN_LOGGING_H_
...
#define PA_PCSCAN_VLOG_STREAM(verbose_level)                                 \
  ::pdfium::base::internal::LoggerWithAllowedAllocations(__FILE__, __LINE__, \
                                                         -(verbose_level))   \
      .stream()
...
#endif  // THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_STARSCAN_LOGGING_H_
