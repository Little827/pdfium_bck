...
using ::pdfium::base::internal::kInvalidBucketSize;
using ::pdfium::base::internal::kMaxSuperPagesInPool;
using ::pdfium::base::internal::kMaxSupportedAlignment;
using ::pdfium::base::internal::kNumBuckets;
using ::pdfium::base::internal::kSuperPageSize;
using ::pdfium::base::internal::MaxDirectMapped;
using ::pdfium::base::internal::PartitionPageSize;
