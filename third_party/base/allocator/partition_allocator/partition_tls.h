...
#ifndef THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_PARTITION_TLS_H_
#define THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_PARTITION_TLS_H_
...
using ::pdfium::base::internal::PartitionTlsCreate;
using ::pdfium::base::internal::PartitionTlsGet;
using ::pdfium::base::internal::PartitionTlsKey;
using ::pdfium::base::internal::PartitionTlsSet;
#if BUILDFLAG(IS_WIN)
using ::pdfium::base::internal::PartitionTlsSetOnDllProcessDetach;
#endif  // BUILDFLAG(IS_WIN)

}  // namespace base::internal

#endif  // THIRD_PARTY_BASE_ALLOCATOR_PARTITION_ALLOCATOR_PARTITION_TLS_H_
