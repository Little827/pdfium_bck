...
using ::pdfium::base::AllocPages;
using ::pdfium::base::AllocPagesWithAlignOffset;
using ::pdfium::base::DecommitAndZeroSystemPages;
using ::pdfium::base::DecommitSystemPages;
using ::pdfium::base::DecommittedMemoryIsAlwaysZeroed;
using ::pdfium::base::DiscardSystemPages;
using ::pdfium::base::FreePages;
using ::pdfium::base::GetAllocPageErrorCode;
using ::pdfium::base::GetTotalMappedSize;
using ::pdfium::base::HasReservationForTesting;
using ::pdfium::base::NextAlignedWithOffset;
using ::pdfium::base::PageAccessibilityConfiguration;
using ::pdfium::base::PageAccessibilityDisposition;
using ::pdfium::base::PageTag;
using ::pdfium::base::RecommitSystemPages;
using ::pdfium::base::ReleaseReservation;
using ::pdfium::base::ReserveAddressSpace;
using ::pdfium::base::RoundDownToPageAllocationGranularity;
using ::pdfium::base::RoundDownToSystemPage;
using ::pdfium::base::RoundUpToPageAllocationGranularity;
using ::pdfium::base::RoundUpToSystemPage;
using ::pdfium::base::SetSystemPagesAccess;
using ::pdfium::base::TryRecommitSystemPages;
using ::pdfium::base::TrySetSystemPagesAccess;
