...
#ifndef FXJS_CFX_V8_ISOLATE_WRAPPER_H_
#define FXJS_CFX_V8_ISOLATE_WRAPPER_H_
...
class CFX_V8IsolateWrapper {
 public:
  explicit CFX_V8IsolateWrapper(v8::Isolate* pIsolate);
  virtual ~CFX_V8IsolateWrapper();
...
#endif  // FXJS_CFX_V8_ISOLATE_WRAPPER_H_
