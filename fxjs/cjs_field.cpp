...
// Parses |strFieldNameParsed| and returns the numerical value of the suffix.
// Writes the field name, without the suffix, to |strFieldName|.
// Returns -1 if a suffix cannot be found or is invalid. In this case
// |strFieldName| will contain |strFieldNameParsed|.
