...
void CFXJSE_FormCalcContext::DateFmt(
  ...
  if (argc > 0) {
    ...
    iStyle =
        static_cast<int32_t>(ValueToFloat(info.GetIsolate(), infotyle.get()));
...
void CFXJSE_FormCalcContext::Num2Date(
  ...
  int32_t dDate =
      static_cast<int32_t>(ValueToFloat(info.GetIsolate(), dateValue.get()));
  if (dDate < 1) {
    info.GetReturnValue().SetNull();
    return;
  }
...
void CFXJSE_FormCalcContext::Num2GMTime(
  ...
  int32_t iTime =
      static_cast<int32_t>(ValueToFloat(info.GetIsolate(), timeValue.get()));
  if (abs(iTime) < 1.0) {
    info.GetReturnValue().SetNull();
    return;
  }
...
void CFXJSE_FormCalcContext::Choose(
  ...
  int32_t iIndex =
      static_cast<int32_t>(ValueToFloat(info.GetIsolate(), argOne.get()));
  if (iIndex < 1) {
