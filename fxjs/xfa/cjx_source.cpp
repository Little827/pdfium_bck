...
CJS_Result CJX_Source::next(CFX_V8IsolateWrapper* runtime,
...
CJS_Result CJX_Source::first(CFX_V8IsolateWrapper* runtime,
                             const std::vector<v8::Local<v8::Value>>& params) {
  if (!params.empty())
    return CJS_Result::Failure(JSMessage::kParamError);
...
CJS_Result CJX_Source::isBOF(CFX_V8IsolateWrapper* runtime,
                             const std::vector<v8::Local<v8::Value>>& params) {
  if (!params.empty())
    return CJS_Result::Failure(JSMessage::kParamError);
...
CJS_Result CJX_Source::isEOF(CFX_V8IsolateWrapper* runtime,
                             const std::vector<v8::Local<v8::Value>>& params) {
  if (!params.empty())
    return CJS_Result::Failure(JSMessage::kParamError);
...
CJS_Result CJX_Source::cancel(CFX_V8IsolateWrapper* runtime,
                              const std::vector<v8::Local<v8::Value>>& params) {
  if (!params.empty())
    return CJS_Result::Failure(JSMessage::kParamError);
...
CJS_Result CJX_Source::update(CFX_V8IsolateWrapper* runtime,
                              const std::vector<v8::Local<v8::Value>>& params) {
  if (!params.empty())
    return CJS_Result::Failure(JSMessage::kParamError);
...
CJS_Result CJX_Source::open(CFX_V8IsolateWrapper* runtime,
                            const std::vector<v8::Local<v8::Value>>& params) {
  if (!params.empty())
    return CJS_Result::Failure(JSMessage::kParamError);
...
CJS_Result CJX_Source::addNew(CFX_V8IsolateWrapper* runtime,
                              const std::vector<v8::Local<v8::Value>>& params) {
  if (!params.empty())
    return CJS_Result::Failure(JSMessage::kParamError);
...
CJS_Result CJX_Source::resync(CFX_V8IsolateWrapper* runtime,
                              const std::vector<v8::Local<v8::Value>>& params) {
  if (!params.empty())
    return CJS_Result::Failure(JSMessage::kParamError);
...
CJS_Result CJX_Source::close(CFX_V8IsolateWrapper* runtime,
                             const std::vector<v8::Local<v8::Value>>& params) {
  if (!params.empty())
    return CJS_Result::Failure(JSMessage::kParamError);
...
CJS_Result CJX_Source::last(CFX_V8IsolateWrapper* runtime,
                            const std::vector<v8::Local<v8::Value>>& params) {
  if (!params.empty())
    return CJS_Result::Failure(JSMessage::kParamError);
