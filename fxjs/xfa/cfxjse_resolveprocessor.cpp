...
bool CFXJSE_ResolveProcessor::ResolveNormal(v8::Isolate* pIsolate,
  ...
  // TODO(crbug.com/1472363): Remove annotation.
  BLINK_GC_PLUGIN_IGNORE std::vector<CXFA_Node*> children;
  // TODO(crbug.com/1472363): Remove annotation.
...
bool CFXJSE_ResolveProcessor::ResolveAsterisk(NodeData& rnd) {
  CXFA_Node* curNode = ToNode(rnd.m_CurObject);
  // TODO(crbug.com/1472363): Remove annotation.
  BLINK_GC_PLUGIN_IGNORE std::vector<CXFA_Node*> array =
      curNode->GetNodeListWithFilter(
