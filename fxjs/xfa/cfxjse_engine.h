...
enum XFA_ResolveNode : uint16_t {
  ...
  XFA_RESOLVENODE_Siblings = 1 << 4,
  XFA_RESOLVENODE_Parent = 1 << 5,
  XFA_RESOLVENODE_AnyChild = 1 << 6,
  XFA_RESOLVENODE_ALL = 1 << 7,
  XFA_RESOLVENODE_CreateNode = 1 << 8,
  XFA_RESOLVENODE_Bind = 1 << 9,
  XFA_RESOLVENODE_BindNew = 1 << 10,
};
