...
CJS_Result CJX_Node::applyXSL(CFX_V8IsolateWrapper* runtime,
...
CJS_Result CJX_Node::clone(CFX_V8IsolateWrapper* runtime,
                           const std::vector<v8::Local<v8::Value>>& params) {
  if (params.size() != 1)
    return CJS_Result::Failure(JSMessage::kParamError);
...
CJS_Result CJX_Node::loadXML(CFX_V8IsolateWrapper* runtime,
                             const std::vector<v8::Local<v8::Value>>& params) {
  if (params.empty() || params.size() > 3)
    return CJS_Result::Failure(JSMessage::kParamError);
...
CJS_Result CJX_Node::saveXML(CFX_V8IsolateWrapper* runtime,
                             const std::vector<v8::Local<v8::Value>>& params) {
  if (params.size() > 1)
    return CJS_Result::Failure(JSMessage::kParamError);
