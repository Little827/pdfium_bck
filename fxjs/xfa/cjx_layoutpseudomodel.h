...
class CJX_LayoutPseudoModel final : public CJX_Object {
 ...
 private:
  ...
  CJS_Result AllPageCount(CFX_V8IsolateWrapper* runtime);
  CJS_Result NumberedPageCount(CFX_V8IsolateWrapper* runtime);
  CJS_Result DoHWXYInternal(CFX_V8IsolateWrapper* runtime,
  ...
  std::vector<CXFA_Node*> GetObjArray(CXFA_LayoutProcessor* pDocLayout,
                                      ...
                                      bool bOnPageArea);
  CJS_Result PageInternals(CFX_V8IsolateWrapper* runtime,
                           const std::vector<v8::Local<v8::Value>>& params,
                           bool bAbsPage);
};
