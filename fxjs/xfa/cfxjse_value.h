...
// Result of executing a script. Contains either a return value, or an
// (possibly empty) error object depending upon IsSuccess(). Abstraction
// of a v8::Global that can be used in an environment free of any
// handle-contexts. v8::Locals should be used in all other places.
class CFXJSE_Value {
 public:
  CFXJSE_Value(v8::Isolate* pIsolate, bool success, v8::Local<v8::Value> value);
