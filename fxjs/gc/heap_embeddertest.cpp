...
cppgc::Persistent<PseudoCollectible> s_persistent_ = nullptr;
...
TEST_F(HeapEmbedderTest, NoReferences) {
  ...
  s_persistent_ = cppgc::MakeGarbageCollected<PseudoCollectible>(heap1.get());
  EXPECT_TRUE(s_persistent_->IsLive());
