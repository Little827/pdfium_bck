...
constexpr const wchar_t* kMonths[12] = {L"Jan", L"Feb", L"Mar", L"Apr",
                                        L"May", L"Jun", L"Jul", L"Aug",
                                        L"Sep", L"Oct", L"Nov", L"Dec"};

constexpr const wchar_t* kFullMonths[12] = {
...
double FX_ParseDateUsingFormat(const WideString& value,
  ...
  return FX_MakeDate(FX_MakeDay(nYear, nMonth - 1, nDay),
