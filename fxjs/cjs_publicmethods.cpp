...
constexpr const wchar_t* const kMonths[] = {L"Jan", L"Feb", L"Mar", L"Apr",
                                            L"May", L"Jun", L"Jul", L"Aug",
                                            L"Sep", L"Oct", L"Nov", L"Dec"};

constexpr const wchar_t* const kFullMonths[] = {
    L"January",   L"February", L"March",    L"April",
    L"May",       L"June",     L"July",     L"August",
    L"September", L"October",  L"November", L"December"};

constexpr const wchar_t* const kDateFormats[] = {L"m/d",
                                                 L"m/d/yy",
                                                 L"mm/dd/yy",
                                                 L"mm/yy",
                                                 L"d-mmm",
