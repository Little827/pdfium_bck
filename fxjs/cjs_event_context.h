...
class CJS_EventContext final : public IJS_EventContext {
 public:
  ...
  CJS_EventContext(const CJS_EventContext& that) = delete;
  CJS_EventContext(CJS_EventContext&& that) = delete;
  CJS_EventContext& operator=(const CJS_EventContext& that) = delete;
  CJS_EventContext& operator=(CJS_EventContext&& that) = delete;
