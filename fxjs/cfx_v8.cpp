...
int CFX_V8::ToInt32(v8::Local<v8::Value> pValue) {
  return ToInt32Helper(m_pIsolate.Get(), pValue);
}

bool CFX_V8::ToBoolean(v8::Local<v8::Value> pValue) {
  return ToBooleanHelper(m_pIsolate.Get(), pValue);
}

double CFX_V8::ToDouble(v8::Local<v8::Value> pValue) {
  return ToDoubleHelper(m_pIsolate.Get(), pValue);
}

WideString CFX_V8::ToWideString(v8::Local<v8::Value> pValue) {
  return ToWideStringHelper(m_pIsolate.Get(), pValue);
}

ByteString CFX_V8::ToByteString(v8::Local<v8::Value> pValue) {
  return ToByteStringHelper(m_pIsolate.Get(), pValue);
}
...
// static
int CFX_V8::ToInt32Helper(v8::Isolate* pIsolate, v8::Local<v8::Value> pValue) {
  if (pValue.IsEmpty())
    return 0;
...
// static
bool CFX_V8::ToBooleanHelper(v8::Isolate* pIsolate,
                             v8::Local<v8::Value> pValue) {
  if (pValue.IsEmpty())
    return false;
...
// static
double CFX_V8::ToDoubleHelper(v8::Isolate* pIsolate,
                              v8::Local<v8::Value> pValue) {
  if (pValue.IsEmpty())
    return 0.0;
...
// static
WideString CFX_V8::ToWideStringHelper(v8::Isolate* pIsolate,
                                      v8::Local<v8::Value> pValue) {
  if (pValue.IsEmpty())
    return WideString();
...
// static
ByteString CFX_V8::ToByteStringHelper(v8::Isolate* pIsolate,
                                      v8::Local<v8::Value> pValue) {
  if (pValue.IsEmpty())
    return ByteString();
  v8::MaybeLocal<v8::String> maybe_string =
