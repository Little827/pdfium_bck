...
constexpr const wchar_t kStrViewerType[] = L"pdfium";
constexpr const wchar_t kStrViewerVariation[] = L"Full";
constexpr const wchar_t kStrPlatform[] = L"WIN";
constexpr const wchar_t kStrLanguage[] = L"ENU";
