...
PDFium uses the same build tool as Chromium. See the platform-specific Chromium
build instructions to get started. Replace Chromium's "Get the code"
instructions with PDFium's.
