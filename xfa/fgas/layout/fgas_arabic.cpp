...
const FX_ARBFORMTABLE kFormTable[] = {
...
const uint16_t kShaddaTable[] = {0xFC5E, 0xFC5F, 0xFC60, 0xFC61, 0xFC62};
...
const FX_ARBFORMTABLE* GetArabicFormTable(wchar_t unicode) {
  if (unicode < kFirstFormTableEntry || kLastFormTableEntry > 0x6d5)
    return nullptr;
