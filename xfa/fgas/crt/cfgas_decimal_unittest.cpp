...
TEST(CFGAS_Decimal, FromFloat) {
  ...
  WideString tiny_expected = L"92233720368547758080";
  ...
  WideString teeny_expected = L"100000000376832.0000";
...
TEST(CFGAS_Decimal, FromFloatFractional) {
  WideString case1 = CFGAS_Decimal(123.456, 10).ToWideString();
...
TEST(CFGAS_Decimal, FromString24PlusDigits) {
  CFGAS_Decimal frac(L"119876543210.01234568911");
  EXPECT_STREQ(L"119876543210.01234568911", frac.ToWideString().c_str());
}
