...
TEST(CFGAS_Decimal, FromFloat) {
  ...
  EXPECT_EQ(big_expected.First(8), big.First(8));
  ...
  EXPECT_EQ(tiny_expected.First(8), tiny.First(8));
  ...
  EXPECT_EQ(teeny_expected.First(8), teeny.First(8));
}
...
TEST(CFGAS_Decimal, FromFloatFractional) {
  ...
  EXPECT_EQ(case1_expected.First(8), case1.First(8));
}
