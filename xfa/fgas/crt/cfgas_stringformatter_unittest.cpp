...
TEST_F(CFGAS_StringFormatterTest, GetCategory) {
  EXPECT_EQ(CFGAS_StringFormatter::LocaleCategory::kUnknown,
            fmt(L"en", L"'just text'")->GetCategory());
  EXPECT_EQ(CFGAS_StringFormatter::LocaleCategory::kNull,
            fmt(L"en", L"null{}")->GetCategory());
  EXPECT_EQ(CFGAS_StringFormatter::LocaleCategory::kZero,
            fmt(L"en", L"zero{}")->GetCategory());
  EXPECT_EQ(CFGAS_StringFormatter::LocaleCategory::kNum,
            fmt(L"en", L"num{}")->GetCategory());
  EXPECT_EQ(CFGAS_StringFormatter::LocaleCategory::kText,
            fmt(L"en", L"text{}")->GetCategory());
  EXPECT_EQ(CFGAS_StringFormatter::LocaleCategory::kDateTime,
            fmt(L"en", L"datetime{}")->GetCategory());
  EXPECT_EQ(CFGAS_StringFormatter::LocaleCategory::kTime,
            fmt(L"en", L"time{}")->GetCategory());
  EXPECT_EQ(CFGAS_StringFormatter::LocaleCategory::kDate,
