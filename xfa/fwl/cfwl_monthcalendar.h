...
class CFWL_MonthCalendar final : public CFWL_Widget {
 ...
 private:
  ...
  void DrawBackground(CFXA_GEGraphics* pGraphics, const CFX_Matrix* pMatrix);
  void DrawHeadBK(CFXA_GEGraphics* pGraphics, const CFX_Matrix* pMatrix);
  void DrawLButton(CFXA_GEGraphics* pGraphics, const CFX_Matrix* pMatrix);
  void DrawRButton(CFXA_GEGraphics* pGraphics, const CFX_Matrix* pMatrix);
  void DrawCaption(CFXA_GEGraphics* pGraphics, const CFX_Matrix* pMatrix);
  void DrawSeparator(CFXA_GEGraphics* pGraphics, const CFX_Matrix* pMatrix);
  void DrawDatesInBK(CFXA_GEGraphics* pGraphics, const CFX_Matrix* pMatrix);
  void DrawWeek(CFXA_GEGraphics* pGraphics, const CFX_Matrix* pMatrix);
  void DrawToday(CFXA_GEGraphics* pGraphics, const CFX_Matrix* pMatrix);
  void DrawDatesIn(CFXA_GEGraphics* pGraphics, const CFX_Matrix* pMatrix);
  void DrawDatesOut(CFXA_GEGraphics* pGraphics, const CFX_Matrix* pMatrix);
  void DrawDatesInCircle(CFXA_GEGraphics* pGraphics, const CFX_Matrix* pMatrix);
  CFX_SizeF CalcSize();
  void Layout();
  void CalcHeadSize();
  void CalcTodaySize();
