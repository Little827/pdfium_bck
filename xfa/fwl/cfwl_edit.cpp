...
void CFWL_Edit::DrawWidget(CFXA_GEGraphics* pGraphics,
...
void CFWL_Edit::DrawTextBk(CFXA_GEGraphics* pGraphics,
...
void CFWL_Edit::DrawContent(CFXA_GEGraphics* pGraphics,
                            const CFX_Matrix* pMatrix) {
...
void CFWL_Edit::OnDrawWidget(CFXA_GEGraphics* pGraphics,
                             const CFX_Matrix& matrix) {
