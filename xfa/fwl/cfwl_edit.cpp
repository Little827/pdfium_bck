...
void CFWL_Edit::DrawWidget(GFGAS_GEGraphics* pGraphics,
...
void CFWL_Edit::DrawTextBk(GFGAS_GEGraphics* pGraphics,
...
void CFWL_Edit::DrawContent(GFGAS_GEGraphics* pGraphics,
                            const CFX_Matrix* pMatrix) {
...
void CFWL_Edit::OnDrawWidget(GFGAS_GEGraphics* pGraphics,
                             const CFX_Matrix& matrix) {
