...
void CFWL_ScrollBar::DrawWidget(GFGAS_GEGraphics* pGraphics,
...
void CFWL_ScrollBar::DrawTrack(GFGAS_GEGraphics* pGraphics,
                               bool bLower,
...
void CFWL_ScrollBar::DrawArrowBtn(GFGAS_GEGraphics* pGraphics,
                                  bool bMinBtn,
                                  const CFX_Matrix* pMatrix) {
  CFWL_ThemeBackground param;
  param.m_pWidget = this;
...
void CFWL_ScrollBar::DrawThumb(GFGAS_GEGraphics* pGraphics,
                               const CFX_Matrix* pMatrix) {
  CFWL_ThemeBackground param;
  param.m_pWidget = this;
...
void CFWL_ScrollBar::OnDrawWidget(GFGAS_GEGraphics* pGraphics,
                                  const CFX_Matrix& matrix) {
