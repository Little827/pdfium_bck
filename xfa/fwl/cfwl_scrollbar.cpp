...
void CFWL_ScrollBar::DrawWidget(CFXA_GEGraphics* pGraphics,
...
void CFWL_ScrollBar::DrawTrack(CFXA_GEGraphics* pGraphics,
                               bool bLower,
...
void CFWL_ScrollBar::DrawArrowBtn(CFXA_GEGraphics* pGraphics,
                                  bool bMinBtn,
                                  const CFX_Matrix* pMatrix) {
  CFWL_ThemeBackground param;
  param.m_pWidget = this;
...
void CFWL_ScrollBar::DrawThumb(CFXA_GEGraphics* pGraphics,
                               const CFX_Matrix* pMatrix) {
  CFWL_ThemeBackground param;
  param.m_pWidget = this;
...
void CFWL_ScrollBar::OnDrawWidget(CFXA_GEGraphics* pGraphics,
                                  const CFX_Matrix& matrix) {
