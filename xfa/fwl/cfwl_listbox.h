...
class CFWL_ListBox : public CFWL_Widget {
 ...
 private:
  ...
  void DrawBkground(CFXA_GEGraphics* pGraphics, const CFX_Matrix* pMatrix);
  void DrawItems(CFXA_GEGraphics* pGraphics, const CFX_Matrix* pMatrix);
  void DrawItem(CFXA_GEGraphics* pGraphics,
                Item* hItem,
                int32_t Index,
                const CFX_RectF& rtItem,
                const CFX_Matrix* pMatrix);
  void DrawStatic(CFXA_GEGraphics* pGraphics);
