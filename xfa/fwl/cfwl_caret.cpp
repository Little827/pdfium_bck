...
void CFWL_Caret::DrawWidget(GFGAS_GEGraphics* pGraphics,
...
void CFWL_Caret::DrawCaretBK(GFGAS_GEGraphics* pGraphics,
...
void CFWL_Caret::OnDrawWidget(GFGAS_GEGraphics* pGraphics,
                              const CFX_Matrix& matrix) {
