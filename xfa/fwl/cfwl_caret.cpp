...
void CFWL_Caret::DrawWidget(CFXA_GEGraphics* pGraphics,
...
void CFWL_Caret::DrawCaretBK(CFXA_GEGraphics* pGraphics,
...
void CFWL_Caret::OnDrawWidget(CFXA_GEGraphics* pGraphics,
                              const CFX_Matrix& matrix) {
