...
void CFWL_Widget::DrawBackground(CFXA_GEGraphics* pGraphics,
                                 CFWL_Part iPartBk,
...
void CFWL_Widget::DrawBorder(CFXA_GEGraphics* pGraphics,
...
void CFWL_Widget::OnDrawWidget(CFXA_GEGraphics* pGraphics,
                               const CFX_Matrix& matrix) {}
