...
void CFWL_ListBox::DrawWidget(GFGAS_GEGraphics* pGraphics,
...
void CFWL_ListBox::DrawBkground(GFGAS_GEGraphics* pGraphics,
...
void CFWL_ListBox::DrawItems(GFGAS_GEGraphics* pGraphics,
                             const CFX_Matrix* pMatrix) {
  float fPosX = 0.0f;
  if (m_pHorzScrollBar)
    fPosX = m_pHorzScrollBar->GetPos();
...
void CFWL_ListBox::DrawItem(GFGAS_GEGraphics* pGraphics,
                            Item* pItem,
                            int32_t Index,
...
void CFWL_ListBox::OnDrawWidget(GFGAS_GEGraphics* pGraphics,
                                const CFX_Matrix& matrix) {
