...
void CFWL_ScrollBarTP::DrawBackground(const CFWL_ThemeBackground& pParams) {
  ...
  GFGAS_GEGraphics* pGraphics = pParams.m_pGraphics.Get();
...
void CFWL_ScrollBarTP::DrawThumbBtn(GFGAS_GEGraphics* pGraphics,
...
void CFWL_ScrollBarTP::DrawPaw(GFGAS_GEGraphics* pGraphics,
...
void CFWL_ScrollBarTP::DrawTrack(GFGAS_GEGraphics* pGraphics,
                                 const CFX_RectF& rect,
                                 bool bVert,
                                 FWLTHEME_STATE eState,
                                 bool bLowerTrack,
...
void CFWL_ScrollBarTP::DrawMaxMinBtn(GFGAS_GEGraphics* pGraphics,
                                     const CFX_RectF& rect,
