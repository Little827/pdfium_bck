...
void CFWL_ScrollBarTP::DrawBackground(const CFWL_ThemeBackground& pParams) {
  ...
  CFXA_GEGraphics* pGraphics = pParams.m_pGraphics.Get();
...
void CFWL_ScrollBarTP::DrawThumbBtn(CFXA_GEGraphics* pGraphics,
...
void CFWL_ScrollBarTP::DrawPaw(CFXA_GEGraphics* pGraphics,
...
void CFWL_ScrollBarTP::DrawTrack(CFXA_GEGraphics* pGraphics,
                                 const CFX_RectF& rect,
                                 bool bVert,
                                 FWLTHEME_STATE eState,
                                 bool bLowerTrack,
...
void CFWL_ScrollBarTP::DrawMaxMinBtn(CFXA_GEGraphics* pGraphics,
                                     const CFX_RectF& rect,
