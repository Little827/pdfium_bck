...
void CFWL_ScrollBarTP::DrawBackground(const CFWL_ThemeBackground& pParams) {
  ...
  switch (pParams.m_iPart) {
    case CFWL_Part::ForeArrow: {
      DrawMaxMinBtn(pGraphics, pParams.m_rect,
    ...
    case CFWL_Part::Thumb: {
      DrawThumbBtn(pGraphics, pParams.m_rect, bVert, eState, true,
                   pParams.m_matrix);
      break;
    }
    case CFWL_Part::LowerTrack: {
      DrawTrack(pGraphics, pParams.m_rect, bVert, eState, true,
                pParams.m_matrix);
      break;
    }
    case CFWL_Part::UpperTrack: {
      DrawTrack(pGraphics, pParams.m_rect, bVert, eState, false,
                pParams.m_matrix);
      break;
    }
    default:
