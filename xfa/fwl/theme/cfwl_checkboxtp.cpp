...
void CFWL_CheckBoxTP::DrawSignCheck(CFXA_GEGraphics* pGraphics,
...
void CFWL_CheckBoxTP::DrawSignCircle(CFXA_GEGraphics* pGraphics,
                                     const CFX_RectF& rtSign,
                                     FX_ARGB argbFill,
                                     const CFX_Matrix& matrix) {
  CFGAS_GEPath path;
...
void CFWL_CheckBoxTP::DrawSignCross(CFXA_GEGraphics* pGraphics,
                                    const CFX_RectF& rtSign,
                                    FX_ARGB argbFill,
                                    const CFX_Matrix& matrix) {
  CFGAS_GEPath path;
...
void CFWL_CheckBoxTP::DrawSignDiamond(CFXA_GEGraphics* pGraphics,
                                      const CFX_RectF& rtSign,
                                      FX_ARGB argbFill,
                                      const CFX_Matrix& matrix) {
  CFGAS_GEPath path;
...
void CFWL_CheckBoxTP::DrawSignSquare(CFXA_GEGraphics* pGraphics,
                                     const CFX_RectF& rtSign,
                                     FX_ARGB argbFill,
                                     const CFX_Matrix& matrix) {
  CFGAS_GEPath path;
...
void CFWL_CheckBoxTP::DrawSignStar(CFXA_GEGraphics* pGraphics,
                                   const CFX_RectF& rtSign,
                                   FX_ARGB argbFill,
                                   const CFX_Matrix& matrix) {
  CFGAS_GEPath path;
