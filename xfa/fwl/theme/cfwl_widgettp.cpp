...
void CFWL_WidgetTP::DrawText(const CFWL_ThemeText& pParams) {
  ...
  GFGAS_GEGraphics* pGraphics = pParams.m_pGraphics;
...
void CFWL_WidgetTP::DrawBorder(GFGAS_GEGraphics* pGraphics,
...
void CFWL_WidgetTP::FillBackground(GFGAS_GEGraphics* pGraphics,
                                   const CFX_RectF& rect,
                                   const CFX_Matrix& matrix) {
  FillSolidRect(pGraphics, FWLTHEME_COLOR_Background, rect, matrix);
}

void CFWL_WidgetTP::FillSolidRect(GFGAS_GEGraphics* pGraphics,
                                  FX_ARGB fillColor,
                                  const CFX_RectF& rect,
                                  const CFX_Matrix& matrix) {
  if (!pGraphics)
...
void CFWL_WidgetTP::DrawFocus(GFGAS_GEGraphics* pGraphics,
                              const CFX_RectF& rect,
                              const CFX_Matrix& matrix) {
  if (!pGraphics)
    return;
...
void CFWL_WidgetTP::DrawArrow(GFGAS_GEGraphics* pGraphics,
                              const CFX_RectF& rect,
...
void CFWL_WidgetTP::DrawBtn(GFGAS_GEGraphics* pGraphics,
                            const CFX_RectF& rect,
...
void CFWL_WidgetTP::DrawArrowBtn(GFGAS_GEGraphics* pGraphics,
                                 const CFX_RectF& rect,
                                 FWLTHEME_DIRECTION eDict,
                                 FWLTHEME_STATE eState,
                                 const CFX_Matrix& matrix) {
