...
void CFWL_WidgetTP::DrawText(const CFWL_ThemeText& pParams) {
  ...
  CFXA_GEGraphics* pGraphics = pParams.m_pGraphics;
...
void CFWL_WidgetTP::DrawBorder(CFXA_GEGraphics* pGraphics,
...
void CFWL_WidgetTP::FillBackground(CFXA_GEGraphics* pGraphics,
                                   const CFX_RectF& rect,
                                   const CFX_Matrix& matrix) {
  FillSolidRect(pGraphics, FWLTHEME_COLOR_Background, rect, matrix);
}

void CFWL_WidgetTP::FillSolidRect(CFXA_GEGraphics* pGraphics,
                                  FX_ARGB fillColor,
                                  const CFX_RectF& rect,
                                  const CFX_Matrix& matrix) {
  if (!pGraphics)
...
void CFWL_WidgetTP::DrawFocus(CFXA_GEGraphics* pGraphics,
                              const CFX_RectF& rect,
                              const CFX_Matrix& matrix) {
  if (!pGraphics)
    return;
...
void CFWL_WidgetTP::DrawArrow(CFXA_GEGraphics* pGraphics,
                              const CFX_RectF& rect,
...
void CFWL_WidgetTP::DrawBtn(CFXA_GEGraphics* pGraphics,
                            const CFX_RectF& rect,
...
void CFWL_WidgetTP::DrawArrowBtn(CFXA_GEGraphics* pGraphics,
                                 const CFX_RectF& rect,
                                 FWLTHEME_DIRECTION eDict,
                                 FWLTHEME_STATE eState,
                                 const CFX_Matrix& matrix) {
