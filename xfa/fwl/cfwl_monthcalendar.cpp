...
void CFWL_MonthCalendar::DrawWidget(CFXA_GEGraphics* pGraphics,
...
void CFWL_MonthCalendar::DrawBackground(CFXA_GEGraphics* pGraphics,
...
void CFWL_MonthCalendar::DrawHeadBK(CFXA_GEGraphics* pGraphics,
                                    const CFX_Matrix* pMatrix) {
  CFWL_ThemeBackground params;
  params.m_pWidget = this;
...
void CFWL_MonthCalendar::DrawLButton(CFXA_GEGraphics* pGraphics,
                                     const CFX_Matrix* pMatrix) {
  CFWL_ThemeBackground params;
  params.m_pWidget = this;
...
void CFWL_MonthCalendar::DrawRButton(CFXA_GEGraphics* pGraphics,
                                     const CFX_Matrix* pMatrix) {
  CFWL_ThemeBackground params;
  params.m_pWidget = this;
...
void CFWL_MonthCalendar::DrawCaption(CFXA_GEGraphics* pGraphics,
                                     const CFX_Matrix* pMatrix) {
...
void CFWL_MonthCalendar::DrawSeparator(CFXA_GEGraphics* pGraphics,
                                       const CFX_Matrix* pMatrix) {
  CFWL_ThemeBackground params;
  params.m_pWidget = this;
...
void CFWL_MonthCalendar::DrawDatesInBK(CFXA_GEGraphics* pGraphics,
                                       const CFX_Matrix* pMatrix) {
  CFWL_ThemeBackground params;
  params.m_pWidget = this;
...
void CFWL_MonthCalendar::DrawWeek(CFXA_GEGraphics* pGraphics,
                                  const CFX_Matrix* pMatrix) {
...
void CFWL_MonthCalendar::DrawToday(CFXA_GEGraphics* pGraphics,
                                   const CFX_Matrix* pMatrix) {
  CFWL_ThemeText params;
  params.m_pWidget = this;
...
void CFWL_MonthCalendar::DrawDatesIn(CFXA_GEGraphics* pGraphics,
                                     const CFX_Matrix* pMatrix) {
  CFWL_ThemeText params;
  params.m_pWidget = this;
...
void CFWL_MonthCalendar::DrawDatesOut(CFXA_GEGraphics* pGraphics,
                                      const CFX_Matrix* pMatrix) {
  CFWL_ThemeText params;
  params.m_pWidget = this;
...
void CFWL_MonthCalendar::DrawDatesInCircle(CFXA_GEGraphics* pGraphics,
                                           const CFX_Matrix* pMatrix) {
...
void CFWL_MonthCalendar::OnDrawWidget(CFXA_GEGraphics* pGraphics,
                                      const CFX_Matrix& matrix) {
