...
void CXFA_Fill::Draw(GFGAS_GEGraphics* pGS,
...
void CXFA_Fill::DrawStipple(GFGAS_GEGraphics* pGS,
                            CFGAS_GEPath* fillPath,
                            const CFX_RectF& rtWidget,
                            const CFX_Matrix& matrix) {
...
void CXFA_Fill::DrawRadial(GFGAS_GEGraphics* pGS,
                           CFGAS_GEPath* fillPath,
                           const CFX_RectF& rtWidget,
                           const CFX_Matrix& matrix) {
  CXFA_Radial* radial =
...
void CXFA_Fill::DrawLinear(GFGAS_GEGraphics* pGS,
                           CFGAS_GEPath* fillPath,
                           const CFX_RectF& rtWidget,
                           const CFX_Matrix& matrix) {
  CXFA_Linear* linear =
...
void CXFA_Fill::DrawPattern(GFGAS_GEGraphics* pGS,
                            CFGAS_GEPath* fillPath,
                            const CFX_RectF& rtWidget,
                            const CFX_Matrix& matrix) {
