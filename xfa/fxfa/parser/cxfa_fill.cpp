...
void CXFA_Fill::Draw(CFXA_GEGraphics* pGS,
...
void CXFA_Fill::DrawStipple(CFXA_GEGraphics* pGS,
                            CFGAS_GEPath* fillPath,
                            const CFX_RectF& rtWidget,
                            const CFX_Matrix& matrix) {
...
void CXFA_Fill::DrawRadial(CFXA_GEGraphics* pGS,
                           CFGAS_GEPath* fillPath,
                           const CFX_RectF& rtWidget,
                           const CFX_Matrix& matrix) {
  CXFA_Radial* radial =
...
void CXFA_Fill::DrawLinear(CFXA_GEGraphics* pGS,
                           CFGAS_GEPath* fillPath,
                           const CFX_RectF& rtWidget,
                           const CFX_Matrix& matrix) {
  CXFA_Linear* linear =
...
void CXFA_Fill::DrawPattern(CFXA_GEGraphics* pGS,
                            CFGAS_GEPath* fillPath,
                            const CFX_RectF& rtWidget,
                            const CFX_Matrix& matrix) {
