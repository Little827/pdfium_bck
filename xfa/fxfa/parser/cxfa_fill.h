...
class CXFA_Fill final : public CXFA_Node {
 public:
  ...
  void Draw(GFGAS_GEGraphics* pGS,
 ...
 private:
  ...
  void DrawStipple(GFGAS_GEGraphics* pGS,
                   CFGAS_GEPath* fillPath,
                   const CFX_RectF& rtWidget,
                   const CFX_Matrix& matrix);
  void DrawRadial(GFGAS_GEGraphics* pGS,
                  CFGAS_GEPath* fillPath,
                  const CFX_RectF& rtWidget,
                  const CFX_Matrix& matrix);
  void DrawLinear(GFGAS_GEGraphics* pGS,
                  CFGAS_GEPath* fillPath,
                  const CFX_RectF& rtWidget,
                  const CFX_Matrix& matrix);
  void DrawPattern(GFGAS_GEGraphics* pGS,
                   CFGAS_GEPath* fillPath,
                   const CFX_RectF& rtWidget,
                   const CFX_Matrix& matrix);
};
