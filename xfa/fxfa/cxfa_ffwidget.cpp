...
void XFA_DrawImage(GFGAS_GEGraphics* pGS,
...
void CXFA_FFWidget::RenderWidget(GFGAS_GEGraphics* pGS,
                                 const CFX_Matrix& matrix,
...
void CXFA_FFWidget::DrawBorder(GFGAS_GEGraphics* pGS,
                               CXFA_Box* box,
...
void CXFA_FFWidget::DrawBorderWithFlag(GFGAS_GEGraphics* pGS,
                                       CXFA_Box* box,
                                       const CFX_RectF& rtBorder,
                                       const CFX_Matrix& matrix,
                                       bool forceRound) {
