...
void XFA_DrawImage(CFXA_GEGraphics* pGS,
...
void CXFA_FFWidget::RenderWidget(CFXA_GEGraphics* pGS,
                                 const CFX_Matrix& matrix,
...
void CXFA_FFWidget::DrawBorder(CFXA_GEGraphics* pGS,
                               CXFA_Box* box,
...
void CXFA_FFWidget::DrawBorderWithFlag(CFXA_GEGraphics* pGS,
                                       CXFA_Box* box,
                                       const CFX_RectF& rtBorder,
                                       const CFX_Matrix& matrix,
                                       bool forceRound) {
