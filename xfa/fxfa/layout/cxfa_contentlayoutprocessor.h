...
class CXFA_ContentLayoutProcessor {
 public:
  ...
  cppgc::Persistent<CXFA_ContentLayoutItem> ExtractLayoutItem();
 ...
 private:
  ...
  cppgc::Persistent<CXFA_ContentLayoutItem> m_pOldLayoutItem;
  ...
  std::vector<cppgc::Persistent<CXFA_ContentLayoutItem>> m_ArrayKeepItems;
