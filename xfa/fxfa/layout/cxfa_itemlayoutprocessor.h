...
class CXFA_ItemLayoutProcessor {
 public:
  ...
  CXFA_ItemLayoutProcessor::Result DoLayout(bool bUseBreakControl,
                                            float fHeightLimit,
                                            float fRealHeight,
 ...
 private:
  ...
  CXFA_ItemLayoutProcessor::Result DoLayoutFlowedContainer(
  ...
  CXFA_ItemLayoutProcessor::Result InsertFlowedItem(
