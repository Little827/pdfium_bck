...
class CXFA_LayoutProcessor : public CXFA_Document::LayoutProcessorIface {
 public:
  ...
  CXFA_ContentlLayoutProcessor* GetRootRootItemLayoutProcessor() const {
 ...
 private:
  ...
  std::unique_ptr<CXFA_ViewLayoutProcessor> m_pLayoutPageMgr;
  std::unique_ptr<CXFA_ContentlLayoutProcessor> m_pRootItemLayoutProcessor;
