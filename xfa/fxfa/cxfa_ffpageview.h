...
class CXFA_FFPageView final : public cppgc::GarbageCollected<CXFA_FFPageView>,
 ...
 public:
  ...
  IXFA_WidgetIterator* CreateFormWidgetIterator(uint32_t dwWidgetFilter);
  IXFA_WidgetIterator* CreateTraverseWidgetIterator(uint32_t dwWidgetFilter);
...
class CXFA_FFTabOrderPageWidgetIterator final
 ...
 private:
  ...
  cppgc::Member<CXFA_ViewLayoutItem> m_pPageViewLayout;
