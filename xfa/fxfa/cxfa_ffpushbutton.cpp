...
void CXFA_FFPushButton::RenderWidget(GFGAS_GEGraphics* pGS,
...
void CXFA_FFPushButton::RenderHighlightCaption(GFGAS_GEGraphics* pGS,
                                               CFX_Matrix* pMatrix) {
...
void CXFA_FFPushButton::OnDrawWidget(GFGAS_GEGraphics* pGraphics,
                                     const CFX_Matrix& matrix) {
