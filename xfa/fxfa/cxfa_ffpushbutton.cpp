...
void CXFA_FFPushButton::RenderWidget(CFXA_GEGraphics* pGS,
...
void CXFA_FFPushButton::RenderHighlightCaption(CFXA_GEGraphics* pGS,
                                               CFX_Matrix* pMatrix) {
...
void CXFA_FFPushButton::OnDrawWidget(CFXA_GEGraphics* pGraphics,
                                     const CFX_Matrix& matrix) {
