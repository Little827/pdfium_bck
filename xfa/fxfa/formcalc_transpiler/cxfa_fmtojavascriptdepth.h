...
#ifndef XFA_FXFA_FORMCALC_TRANSPILER_CXFA_FMTOJAVASCRIPTDEPTH_H_
#define XFA_FXFA_FORMCALC_TRANSPILER_CXFA_FMTOJAVASCRIPTDEPTH_H_
...
#endif  // XFA_FXFA_FORMCALC_TRANSPILER_CXFA_FMTOJAVASCRIPTDEPTH_H_
