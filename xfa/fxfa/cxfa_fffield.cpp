...
CFX_RectF CXFA_FFField::GetBBox(FocusOption focus) {
  if (focus == FocusOption::kDoNotDraw)
    return CXFA_FFWidget::GetBBox(FocusOption::kDoNotDraw);
...
void CXFA_FFField::RenderWidget(CXFA_Graphics* pGS,
  ...
  DrawHighlight(pGS, &mtRotate, highlight, ShapeOption::kSquare);
...
void CXFA_FFField::DrawHighlight(CXFA_Graphics* pGS,
                                 ...
                                 HighlightOption highlight,
                                 ShapeOption shape) {
  if (highlight == HighlightOption::kNoHighlight)
    return;
