...
void CXFA_FFField::RenderWidget(CFXA_GEGraphics* pGS,
...
void CXFA_FFField::DrawHighlight(CFXA_GEGraphics* pGS,
                                 CFX_Matrix* pMatrix,
                                 HighlightOption highlight,
                                 ShapeOption shape) {
...
void CXFA_FFField::DrawFocus(CFXA_GEGraphics* pGS, CFX_Matrix* pMatrix) {
...
void CXFA_FFField::RenderCaption(CFXA_GEGraphics* pGS, CFX_Matrix* pMatrix) {
  CXFA_TextLayout* pCapTextLayout = m_pNode->GetCaptionTextLayout();
  if (!pCapTextLayout)
    return;
...
void CXFA_FFField::OnDrawWidget(CFXA_GEGraphics* pGraphics,
                                const CFX_Matrix& matrix) {}
