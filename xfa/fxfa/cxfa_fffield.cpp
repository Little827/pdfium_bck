...
void CXFA_FFField::RenderWidget(GFGAS_GEGraphics* pGS,
...
void CXFA_FFField::DrawHighlight(GFGAS_GEGraphics* pGS,
                                 CFX_Matrix* pMatrix,
                                 HighlightOption highlight,
                                 ShapeOption shape) {
...
void CXFA_FFField::DrawFocus(GFGAS_GEGraphics* pGS, CFX_Matrix* pMatrix) {
...
void CXFA_FFField::RenderCaption(GFGAS_GEGraphics* pGS, CFX_Matrix* pMatrix) {
  CXFA_TextLayout* pCapTextLayout = m_pNode->GetCaptionTextLayout();
  if (!pCapTextLayout)
    return;
...
void CXFA_FFField::OnDrawWidget(GFGAS_GEGraphics* pGraphics,
                                const CFX_Matrix& matrix) {}
