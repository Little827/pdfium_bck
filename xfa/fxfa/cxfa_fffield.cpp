...
bool CXFA_FFField::OnKeyDown(uint32_t dwKeyCode, uint32_t dwFlags) {
  ...
  CFWL_MessageKey msg(GetNormalWidget(), CFWL_MessageKey::SubType::kKeyDown,
                      dwFlags, dwKeyCode);
  SendMessageToFWLWidget(&msg);
  return true;
}
...
bool CXFA_FFField::OnKeyUp(uint32_t dwKeyCode, uint32_t dwFlags) {
  ...
  CFWL_MessageKey msg(GetNormalWidget(), CFWL_MessageKey::SubType::kKeyUp,
                      dwFlags, dwKeyCode);
  SendMessageToFWLWidget(&msg);
  return true;
}
...
bool CXFA_FFField::OnChar(uint32_t dwChar, uint32_t dwFlags) {
  ...
  CFWL_MessageKey msg(GetNormalWidget(), CFWL_MessageKey::SubType::kChar,
                      dwFlags, dwChar);
  SendMessageToFWLWidget(&msg);
  return true;
}
