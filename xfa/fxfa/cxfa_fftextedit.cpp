...
bool CXFA_FFTextEdit::OnLButtonDown(Mask<FWL_KeyFlag> dwFlags,
                                    const CFX_PointF& point) {
  if (!IsFocused()) {
...
bool CXFA_FFTextEdit::OnRButtonDown(Mask<FWL_KeyFlag> dwFlags,
                                    const CFX_PointF& point) {
  if (!IsFocused()) {
    GetLayoutItem()->SetStatusBits(XFA_WidgetStatus_Focused);
    UpdateFWLData();
...
bool CXFA_FFTextEdit::OnRButtonUp(Mask<FWL_KeyFlag> dwFlags,
                                  const CFX_PointF& point) {
