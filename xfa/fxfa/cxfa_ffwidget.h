...
class CXFA_FFWidget : public cppgc::GarbageCollected<CXFA_FFWidget>,
 ...
 public:
  ...
  virtual bool OnLButtonDown(Mask<FWL_KeyFlag> dwFlags,
                             const CFX_PointF& point) WARN_UNUSED_RESULT;
  virtual bool OnLButtonUp(Mask<FWL_KeyFlag> dwFlags,
                           const CFX_PointF& point) WARN_UNUSED_RESULT;
  virtual bool OnLButtonDblClk(Mask<FWL_KeyFlag> dwFlags,
                               const CFX_PointF& point) WARN_UNUSED_RESULT;
  virtual bool OnMouseMove(Mask<FWL_KeyFlag> dwFlags,
                           const CFX_PointF& point) WARN_UNUSED_RESULT;
  virtual bool OnMouseWheel(Mask<FWL_KeyFlag> dwFlags,
                            const CFX_PointF& point,
                            const CFX_Vector& delta) WARN_UNUSED_RESULT;
  virtual bool OnRButtonDown(Mask<FWL_KeyFlag> dwFlags,
                             const CFX_PointF& point) WARN_UNUSED_RESULT;
  virtual bool OnRButtonUp(Mask<FWL_KeyFlag> dwFlags,
                           const CFX_PointF& point) WARN_UNUSED_RESULT;
  virtual bool OnRButtonDblClk(Mask<FWL_KeyFlag> dwFlags,
                               const CFX_PointF& point) WARN_UNUSED_RESULT;
  ...
  virtual bool OnKeyDown(XFA_FWL_VKEYCODE dwKeyCode,
                         Mask<FWL_KeyFlag> dwFlags) WARN_UNUSED_RESULT;
