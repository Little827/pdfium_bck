...
add_entries_for_builder(name = "linux_xfa_skia", category = "xfa|linux", short_name = "skia")
add_entries_for_builder(name = "linux_xfa_skia_paths", category = "xfa|linux", short_name = "skia_paths")
...
add_entries_for_builder(name = "mac_xfa_skia", category = "xfa|mac", short_name = "skia")
add_entries_for_builder(name = "mac_xfa_skia_paths", category = "xfa|mac", short_name = "skia_paths")
...
add_entries_for_builder(name = "win_xfa_skia", category = "xfa|win", short_name = "skia")
add_entries_for_builder(name = "win_xfa_skia_paths", category = "xfa|win", short_name = "skia_paths")
