...
class CBC_PDF417HighLevelEncoder {
 ...
 private:
  ...
  static constexpr int32_t LATCH_TO_TEXT = 900;
  static constexpr int32_t LATCH_TO_BYTE_PADDED = 901;
  static constexpr int32_t LATCH_TO_NUMERIC = 902;
  static constexpr int32_t SHIFT_TO_BYTE = 913;
  static constexpr int32_t LATCH_TO_BYTE = 924;
