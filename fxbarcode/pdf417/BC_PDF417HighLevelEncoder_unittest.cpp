...
TEST(PDF417HighLevelEncoderTest, EncodeHighLevel) {
  static constexpr struct EncodeHighLevelCase {
    ...
    int expected_length;
      ...
      {L"xxxxxx0x", L"\x0384\x0341\x02c9\x02c9\x02ce\x1b\x02cf", 7},

      // Text mode with mixed submode, and space in alpha submode.
      {L"xxxxxx0X ", L"\x0384\x0341\x02c9\x02c9\x02ce\x1c\x02cc", 7},

      // Text mode to binary mode.
      {L"xxxxxx\v", L"\x0384\x0341\x02c9\x02c9\x02cf\x0391\x0385\v", 8},

      // 13 consecutive digits triggers numeric encoding.
      {L"0000000000000", L"\x0386\x0f\xd9\x017b\x0b\x64", 6},
  };
