...
class CBC_TwoDimWriter : public CBC_Writer {
 public:
  ...
  int32_t get_error_correction_level() const { return m_iCorrectLevel; }

 protected:
  void set_error_correction_level(int32_t level) { m_iCorrectLevel = level; }
