...
TEST(StringPool, ByteString) {
  ...
  EXPECT_EQ(nullptr, null1.data_.Get());
  EXPECT_EQ(nullptr, null2.data_.Get());
  ...
  EXPECT_EQ(nullptr, interned_null1.data_.Get());
  EXPECT_EQ(nullptr, interned_null2.data_.Get());
