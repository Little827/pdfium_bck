...
TEST(CFX_Matrix, ComposeTransformations) {
  // sin(Pi/2) and cos(Pi/2) have a tiny error and are not exactly 1.0f and
  // 0.0f. The rotation matrix is thus not perfect.

  CFX_Matrix rotate_90;
  rotate_90.Rotate(pdfium::base::kPiFloat / 2);
