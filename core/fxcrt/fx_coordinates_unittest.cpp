...
TEST(CFX_Matrix, ComposeTransformations) {
  ...
  EXPECT_NEAR_FIVE_PLACES(1.0f, translate_23_11.a);
  EXPECT_NEAR_FIVE_PLACES(0.0f, translate_23_11.b);
  EXPECT_NEAR_FIVE_PLACES(0.0f, translate_23_11.c);
  EXPECT_NEAR_FIVE_PLACES(1.0f, translate_23_11.d);
  EXPECT_FLOAT_EQ(23.0f, translate_23_11.e);
  EXPECT_FLOAT_EQ(11.0f, translate_23_11.f);

  CFX_Matrix scale_5_13;
  scale_5_13.Scale(5, 13);
  EXPECT_NEAR_FIVE_PLACES(5.0f, scale_5_13.a);
  EXPECT_NEAR_FIVE_PLACES(0.0f, scale_5_13.b);
  EXPECT_NEAR_FIVE_PLACES(0.0f, scale_5_13.c);
  EXPECT_NEAR_FIVE_PLACES(13.0f, scale_5_13.d);
  ...
  // Note how the results are equal to the results when applying step-by-step.
