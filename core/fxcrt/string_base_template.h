...
#ifndef CORE_FXCRT_STRING_BASE_TEMPLATE_H_
#define CORE_FXCRT_STRING_BASE_TEMPLATE_H_
...
extern template class StringBaseTemplate<char>;
extern template class StringBaseTemplate<wchar_t>;

}  // namespace fxcrt

#endif  // CORE_FXCRT_STRING_BASE_TEMPLATE_H_
