...
class ByteString {
 public:
  ...
  static ByteString FormatFloat(float d) WARN_UNUSED_RESULT;
  ...
  explicit ByteString(ByteStringView stringSrc);
  ...
  const ByteString& operator=(ByteStringView stringSrc);
  ...
  size_t Insert(size_t location, char ch);
