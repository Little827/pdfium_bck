...
class TreeNode : public TreeNodeBase<T> {
 ...
 private:
  ...
  T* m_pParent = nullptr;       // Default: Raw, intra-tree pointer.
  T* m_pFirstChild = nullptr;   // Default: Raw, intra-tree pointer.
  T* m_pLastChild = nullptr;    // Default: Raw, intra-tree pointer.
  T* m_pNextSibling = nullptr;  // Default: Raw, intra-tree pointer
  T* m_pPrevSibling = nullptr;  // Default: Raw, intra-tree pointer
};
