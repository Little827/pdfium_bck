...
class TreeNodeBase {
 public:
  ...
  T* GetParent() const { return static_cast<const T*>(this)->m_pParent; }
  T* GetFirstChild() const {
    return static_cast<const T*>(this)->m_pFirstChild;
  }
  T* GetLastChild() const { return static_cast<const T*>(this)->m_pLastChild; }
 ...
 private:
  ...
  void SetParent(T* pParent) { static_cast<T*>(this)->m_pParent = pParent; }
  void SetFirstChild(T* pChild) {
    static_cast<T*>(this)->m_pFirstChild = pChild;
  }
  void SetLastChild(T* pChild) { static_cast<T*>(this)->m_pLastChild = pChild; }
  void SetNextSibling(T* pSibling) {
    static_cast<T*>(this)->m_pNextSibling = pSibling;
  }
  void SetPrevSibling(T* pSibling) {
