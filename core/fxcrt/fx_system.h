...
#define FXSYS_IsFloatBigger(fa, fb) ((fa) > (fb) && !IsFloatZero((fa) - (fb)))
#define FXSYS_IsFloatSmaller(fa, fb) ((fa) < (fb) && !IsFloatZero((fa) - (fb)))
#define FXSYS_IsFloatEqual(fa, fb) IsFloatZero((fa) - (fb))
