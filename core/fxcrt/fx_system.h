...
int FXSYS_stricmp(char* str1, char* str2);
int FXSYS_wcsicmp(wchar_t* str1, wchar_t* str2);
int32_t FXSYS_atoi(char* str);
int32_t FXSYS_wtoi(wchar_t* str);
uint32_t FXSYS_atoui(char* str);
int64_t FXSYS_atoi64(char* str);
