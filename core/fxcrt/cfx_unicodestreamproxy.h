...
#ifndef CORE_FXCRT_CFX_UNICODESTREAMPROXY_H_
#define CORE_FXCRT_CFX_UNICODESTREAMPROXY_H_
...
class CFX_UnicodeStreamProxy : public Retainable {
 public:
  enum class From {
    Begin = 0,
    Current,
...
#endif  // CORE_FXCRT_CFX_UNICODESTREAMPROXY_H_
