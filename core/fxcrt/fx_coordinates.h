...
class CFX_Matrix {
 public:
  ...
  void ScalePrepend(float sx, float sy);
  void Rotate(float fRadian);
  void RotatePrepend(float fRadian);

  // Rotates counterclockwise around the (x, y) point.
  void RotateAt(float fRadian, float x, float y);
  void RotateAtPrepend(float fRadian, float x, float y);
  void Shear(float fAlphaRadian, float fBetaRadian);
  void ShearPrepend(float fAlphaRadian, float fBetaRadian);
