...
TEST(WideString, FXUTF8DecodeSupplementary) {
  EXPECT_EQ(
      L"\U00010000"
      L"\U0001f3a8"
      L"\U0010ffff",
...
TEST(WideString, FXUTF8DecodeErrorRecovery) {
...
TEST(WideString, FXUTF8EncodeDecodeConsistency) {
  WideString wstr;
...
TEST(WideString, FXUTF8EncodeDecodeConsistencyUnpairedHighSurrogates) {
  WideString wstr;
  wstr.Reserve(0x400);
...
TEST(WideString, FXUTF8EncodeDecodeConsistencyUnpairedLowSurrogates) {
  WideString wstr;
  wstr.Reserve(0x400);
