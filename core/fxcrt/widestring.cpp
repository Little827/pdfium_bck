...
bool WideString::operator==(const wchar_t* ptr) const {
  ...
  // SAFTEY: wsclen() comparison ensure there are m_nDatLength wchars at ptr
  // before the terminator, and `m_nDataLength` is withing `m_String`.
...
bool WideString::operator==(WideStringView str) const {
  ...
  // SAFTEY: Comparison ensure there are m_nDatLength wchars in `str`
  // and `m_nDataLength is withing `m_String`.
...
bool WideString::operator<(WideStringView str) const {
  ...
  // SAFETY: Comparision limited to minimum valid length of either argument.
...
int WideString::Compare(const WideString& str) const {
  ...
  // SAFTEY: Comparison limited to minium length of arguments.
