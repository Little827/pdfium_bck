...
TEST(ByteString, FX_HashCode_Ascii) {
  ...
  EXPECT_EQ(31u * 65u + 255u, FX_HashCode_GetW("A\xff", false));
  EXPECT_EQ(31u * 97u + 255u, FX_HashCode_GetW("A\xff", true));
}

TEST(ByteString, FX_HashCode_Wide) {
  EXPECT_EQ(0u, FX_HashCode_GetW("", false));
  EXPECT_EQ(65u, FX_HashCode_GetW("A", false));
  EXPECT_EQ(97u, FX_HashCode_GetW("A", true));
  EXPECT_EQ(1313u * 65u + 66u, FX_HashCode_GetW("AB", false));
  EXPECT_EQ(1313u * 65u + 255u, FX_HashCode_GetW("A\xff", false));
  EXPECT_EQ(1313u * 97u + 255u, FX_HashCode_GetW("A\xff", true));
}
