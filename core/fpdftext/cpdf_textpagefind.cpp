...
CPDF_TextPageFind::CPDF_TextPageFind(const CPDF_TextPage* pTextPage,
    ...
    : m_pTextPage(pTextPage),
      ...
      m_findPreStart(GetPreStart(startPos, m_strText)),
...
bool CPDF_TextPageFind::FindPrev() {
  ...
  while (true) {
    ...
    int cur_order = find.GetCurOrder();
    int cur_match = find.GetMatchedCount();
...
// static
std::vector<WideString> CPDF_TextPageFind::ExtractFindWhat(
