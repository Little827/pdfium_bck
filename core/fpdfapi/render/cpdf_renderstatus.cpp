...
CFX_FillRenderOptions GetFillRenderOptionsForDrawPathWithBlend(
...
bool CPDF_RenderStatus::ProcessPath(CPDF_PathObject* pPathObj,
  ...
  return m_pDevice->DrawPathWithBlend(
      ...
      GetFillRenderOptionsForDrawPathWithBlend(options, pPathObj, FillType,
...
bool CPDF_RenderStatus::ProcessText(CPDF_TextObject* textobj,
  ...
  if (bClip || bStroke) {
    ...
    return CPDF_TextRenderer::DrawTextPath(
        ...
        pClippingPath,
        GetFillRenderOptionsForDrawTextPath(m_Options.GetOptions(), textobj,
                                            bStroke, bFill));
  }
