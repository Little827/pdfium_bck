...
struct CoonBezierCoeff {
  ...
  void BezierInterpol(CoonBezierCoeff& C1,
                      CoonBezierCoeff& C2,
                      CoonBezierCoeff& D1,
                      CoonBezierCoeff& D2) {
    a = (D1.a + D2.a) / 2;
...
struct CoonBezier {
  ...
  void BezierInterpol(CoonBezier& C1,
                      CoonBezier& C2,
                      CoonBezier& D1,
                      CoonBezier& D2) {
...
struct CoonColor {
  CoonColor() { memset(comp, 0, sizeof(int) * 3); }
