...
// Test rendering of text with forced color scheme on.
  ...
  VerifyRenderingWithColorScheme("hello_world.pdf", /*flags=*/0, &color_scheme,
...
TEST_F(FPDFProgressiveRenderEmbedderTest, RenderPathWithColorScheme) {
  ...
  VerifyRenderingWithColorScheme("rectangles.pdf", /*flags=*/0, &color_scheme,
...
TEST_F(FPDFProgressiveRenderEmbedderTest,
  ...
  VerifyRenderingWithColorScheme("rectangles.pdf", FPDF_CONVERT_FILL_TO_STROKE,
...
// Normal blend mode.
  ...
  VerifyRenderingWithColorScheme("annotation_highlight_square_with_ap.pdf",
                                 FPDF_ANNOT, &color_scheme, kBlue, 612, 792,
                                 kMD5ContentWithHighlightFill);
}
...
// Normal blend mode.
  ...
  VerifyRenderingWithColorScheme("annotation_highlight_square_with_ap.pdf",
                                 FPDF_ANNOT | FPDF_CONVERT_FILL_TO_STROKE,
                                 &color_scheme, kBlue, 612, 792,
                                 kMD5ContentWithHighlight);
}
...
// Test rendering of multiple ink with forced color scheme on.
  ...
  VerifyRenderingWithColorScheme("annotation_ink_multiple.pdf", FPDF_ANNOT,
                                 &color_scheme, kBlack, 612, 792,
                                 kMD5ContentWithInk);
}
...
// Test rendering of static annotation with forced color scheme on.
  ...
  VerifyRenderingWithColorScheme("annotation_stamp_with_ap.pdf", FPDF_ANNOT,
                                 &color_scheme, kWhite, 595, 842,
                                 kMD5ContentWithStamp);
}
...
// Test rendering of form does not change with forced color scheme on.
  ...
  VerifyRenderingWithColorScheme("text_form.pdf", FPDF_ANNOT, &color_scheme,
                                 kWhite, 300, 300, kMD5ContentWithForm);
}
