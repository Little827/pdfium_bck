...
TEST_F(FPDFProgressiveRenderEmbedderTest, RenderFormWithColorScheme) {
  ...
  static constexpr char kMD5ContentWithForm[] =
      "76a2bc05af68edc251da16c6cfadf74a";

  FPDF_COLORSCHEME color_scheme{kGreen, kGreen, kRed, kRed};

  VerifyRenderingWithColorScheme("form.pdf", FPDF_ANNOT, &color_scheme, kWhite,
                                 300, 300, kMD5ContentWithForm);

  // Verify that the MD5 hash matches when rendered without |color_scheme|.
  VerifyRenderingWithColorScheme("form.pdf", FPDF_ANNOT,
                                 /*color_scheme=*/nullptr, kWhite, 300, 300,
                                 kMD5ContentWithForm);
}
