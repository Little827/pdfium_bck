...
class CPDF_Color {
 public:
  ...
  void SetColorSpace_(RetainPtr<CPDF_ColorSpace> pCS);
  void SetValueForNonPattern_(std::vector<float> values);
  void SetValueForPattern__(RetainPtr<CPDF_Pattern> pPattern,
