...
class CPDF_ColorState {
 public:
  ...
  void SetFillColor_(const RetainPtr<CPDF_ColorSpace>& pCS,
                     std::vector<float>&& values);
  void SetStrokeColor_(const RetainPtr<CPDF_ColorSpace>& pCS,
                       std::vector<float>&& values);
  void SetFillPattern_(const RetainPtr<CPDF_Pattern>& pattern,
                       std::vector<float>&& values);
  void SetStrokePattern_(const RetainPtr<CPDF_Pattern>& pattern,
                         std::vector<float>&& values);
 ...
 private:
  ...
  void SetColor_(const RetainPtr<CPDF_ColorSpace>& pCS,
                 std::vector<float>&& values,
                 CPDF_Color* color,
                 FX_COLORREF* colorref);
  void SetPattern_(const RetainPtr<CPDF_Pattern>& pPattern,
                   std::vector<float>&& values,
                   CPDF_Color* color,
                   FX_COLORREF* colorref);
