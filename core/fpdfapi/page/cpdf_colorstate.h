...
class CPDF_ColorState {
 public:
  ...
  void SetFillColor_(RetainPtr<CPDF_ColorSpace> pCS, std::vector<float> values);
  void SetStrokeColor_(RetainPtr<CPDF_ColorSpace> pCS,
                       std::vector<float> values);
  void SetFillPattern__(RetainPtr<CPDF_Pattern> pattern,
                        pdfium::span<float> values);
  void SetStrokePattern__(RetainPtr<CPDF_Pattern> pattern,
                          pdfium::span<float> values);
 ...
 private:
  ...
  void SetColor_(RetainPtr<CPDF_ColorSpace> pCS,
                 std::vector<float> values,
                 CPDF_Color* color,
                 FX_COLORREF* colorref);
  void SetPattern__(RetainPtr<CPDF_Pattern> pPattern,
                    pdfium::span<float> values,
                    CPDF_Color* color,
                    FX_COLORREF* colorref);
