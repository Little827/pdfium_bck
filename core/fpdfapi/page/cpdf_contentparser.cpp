...
bool CPDF_ContentParser::Continue(PauseIndicatorIface* pPause) {
  std::cerr << "CPDF_ContentParser::Continue m_CurrentStage=" << (int)m_CurrentStage << std::endl;
...
CPDF_ContentParser::Stage CPDF_ContentParser::Parse() {
  ...
  std::cerr << "m_StreamArray[m_CurrentStream]->GetSize() " << m_StreamArray[m_CurrentStream]->GetSize() << std::endl;
