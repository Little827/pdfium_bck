...
FX_COLORREF CPDF_TextObject::GetFillColorRef() const {
  return m_ColorState.GetFillColorRef();
}

FX_COLORREF CPDF_TextObject::GetStrokeColorRef() const {
  return m_ColorState.GetStrokeColorRef();
}
