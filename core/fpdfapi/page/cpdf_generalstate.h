...
class CPDF_GeneralState {
 public:
  ...
  void SetTR(RetainPtr<CPDF_Object> pObject);
  ...
  void SetBG(RetainPtr<CPDF_Object> pObject);
  void SetUCR(RetainPtr<CPDF_Object> pObject);
  void SetHT(RetainPtr<CPDF_Object> pObject);
