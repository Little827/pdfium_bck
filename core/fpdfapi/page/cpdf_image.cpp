...
RetainPtr<CPDF_Dictionary> CPDF_Image::InitJPEG(
  ...
  RetainPtr<CPDF_Dictionary> pDict =
      CreateXObjectImage(info.width, info.height);
...
void CPDF_Image::SetImage(const RetainPtr<CFX_DIBitmap>& pBitmap) {
  ...
  RetainPtr<CPDF_Dictionary> pDict =
      CreateXObjectImage(BitmapWidth, BitmapHeight);
  ...
  if (pMaskBitmap) {
    ...
    RetainPtr<CPDF_Dictionary> pMaskDict =
        CreateXObjectImage(maskWidth, maskHeight);
...
RetainPtr<CPDF_Dictionary> CPDF_Image::CreateXObjectImage(int width,
                                                          int height) {
