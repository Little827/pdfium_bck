...
JpxDecodeAction GetJpxDecodeActionFromColorSpaces(
  ...
  // component number from the JPX image is not. The JPX image components could
  // have extra information stored in them besides color channels, such as
  // transparency. Therefore these two component numbers can be different. Many
  // PDFs generated by iOS meets this condition. See https://crbug.com/1012369dd
  // for example.
  if (pdf_colorspace->CountComponents() == 3 &&
      jpx_info.colorspace == OPJ_CLRSPC_SRGB) {
    if (jpx_info.components > 3) {
