...
TEST(CPDF_DeviceCSTest, GetRGBFromGray) {
  ...
  float B;
  auto device_gray =
      fxcrt::MakeRetain<CPDF_DeviceCS>(CPDF_ColorSpace::Family::kDeviceGray);
...
TEST(CPDF_DeviceCSTest, GetRGBFromRGB) {
  ...
  float B;
  auto device_rgb =
      fxcrt::MakeRetain<CPDF_DeviceCS>(CPDF_ColorSpace::Family::kDeviceRGB);
...
TEST(CPDF_DeviceCSTest, GetRGBFromCMYK) {
  ...
  float B;
  auto device_cmyk =
      fxcrt::MakeRetain<CPDF_DeviceCS>(CPDF_ColorSpace::Family::kDeviceCMYK);
