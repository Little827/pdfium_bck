...
TEST(CPDF_DeviceCSTest, GetRGBFromGray) {
  ...
  color_buffer.m_Comps = buf;
  ASSERT_TRUE(device_gray.GetRGB(&color_buffer, &R, &G, &B));
...
TEST(CPDF_DeviceCSTest, GetRGBFromRGB) {
  ...
  ColorBuffer color_buffer;
  color_buffer.m_Comps = buf;
  ASSERT_TRUE(device_rgb.GetRGB(&color_buffer, &R, &G, &B));
...
TEST(CPDF_DeviceCSTest, GetRGBFromCMYK) {
  ...
  ColorBuffer color_buffer;
  color_buffer.m_Comps = buf;
  ASSERT_TRUE(device_cmyk.GetRGB(&color_buffer, &R, &G, &B));
