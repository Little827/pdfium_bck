...
RetainPtr<CPDF_ColorSpace> CPDF_ColorSpace::Load(
  ...
  RetainPtr<CPDF_ColorSpace> pCS = CPDF_ColorSpace::AllocateColorSpaceForName(
      pDoc, familyname.AsStringView());
  if (!pCS)
    return nullptr;
...
// static
RetainPtr<CPDF_ColorSpace> CPDF_ColorSpace::AllocateColorSpaceForName(
