...
class CPDF_DocPageData {
 ...
 private:
  ...
  // CPDF_ColorSpace::Load() and |pVisitedLocal| is also passed recursively to
  // avoid circular calls with this method calling itself.
  CPDF_ColorSpace* GetColorSpaceInternal(CPDF_Object* pCSObj,
                                         const CPDF_Dictionary* pResources,
                                         std::set<CPDF_Object*>* pVisited,
