...
void CPDF_Type3Char::ParseContent(const CPDF_AllStates* pGraphicStates,
                                  const CFX_Matrix* pParentMatrix,
                                  CPDF_Type3Char* pType3Char,
                                  std::set<const uint8_t*>* parsedSet) {
  m_pForm->ParseContent(pGraphicStates, pParentMatrix, pType3Char, parsedSet);
}

size_t CPDF_Type3Char::GetPageObjectCount() const {
