...
class CPDF_CIDFont final : public CPDF_Font {
 public:
  ...
  uint16_t GetVertWidth(uint16_t cid) const;
  void GetVertOrigin(uint16_t cid, uint16_t& vx, uint16_t& vy) const;
 ...
 private:
  ...
  uint16_t m_DefaultVY = 880;
  uint16_t m_DefaultW1 = -1000;
