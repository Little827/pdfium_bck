...
TEST(cpdf_tounicodemap, StringToCode) {
  EXPECT_EQ(194u, CPDF_ToUnicodeMap::StringToCode("<c2").value());
  EXPECT_EQ(162u, CPDF_ToUnicodeMap::StringToCode("<A2").value());
  EXPECT_EQ(2802u, CPDF_ToUnicodeMap::StringToCode("<Af2").value());
