...
class CPDF_Array final : public CPDF_Object {
 public:
  ...
  // in those cases. Additionally, the methods named after CPDF_Object
  // sub-classes safely coerce to the sub-class, returning nullptr if the
  // object at the location is of a different type.
  ...
  // equal to the current array size, then rtains reference to `pObj`, and
