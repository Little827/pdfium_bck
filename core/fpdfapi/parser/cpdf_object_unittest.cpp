 ...
 public:
  void SetUp() override {
    ...
    CPDF_Object* objs[] = {boolean_false_obj, boolean_true_obj, number_int_obj,
                           ...
                           stream_obj,        null_obj};
    m_DirectObjTypes = {
        CPDF_Object::kBoolean, CPDF_Object::BOOLEAN, CPDF_Object::NUMBER,
        CPDF_Object::kNumber,  CPDF_Object::STRING,  CPDF_Object::STRING,
        CPDF_Object::kName,    CPDF_Object::ARRAY,   CPDF_Object::DICTIONARY,
        CPDF_Object::kStream,  CPDF_Object::NULLOBJ};
