...
TEST(fpdf_parser_utility, ValidateResourceDict) {
...

  {
    ...
    // Empty dict is ok.
    EXPECT_TRUE(ValidateResourceDict(dict.Get(), "foo"));
    EXPECT_TRUE(ValidateResourceDict(dict.Get(), "bar"));

    // nullptr is not.
    EXPECT_FALSE(ValidateResourceDict(nullptr, "foo"));
    EXPECT_FALSE(ValidateResourceDict(nullptr, "bar"));
    ...
    EXPECT_FALSE(ValidateResourceDict(dict.Get(), "foo"));
    EXPECT_FALSE(ValidateResourceDict(dict.Get(), "bar"));
