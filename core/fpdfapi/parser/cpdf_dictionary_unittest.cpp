...
TEST(DictionaryTest, LockerGetters) {
  ...
  EXPECT_FALSE(locked_dict.GetObjectFor("E"));
  EXPECT_FALSE(locked_dict.GetArrayFor("E"));
  EXPECT_FALSE(locked_dict.GetDictFor("E"));
  EXPECT_FALSE(locked_dict.GetStreamFor("E"));
  EXPECT_FALSE(locked_dict.GetNumberFor("E"));
}
