...
FX_RECT FXRectFromFTPos(FT_Pos left,
                        FT_Pos top,
                        FT_Pos right,
                        FT_Pos bottom,
                        int x_scale,
  ...
  return FX_RECT(pdfium::base::checked_cast<int32_t>(left * 1000 / x_scale),
                 pdfium::base::checked_cast<int32_t>(top * 1000 / y_scale),
                 pdfium::base::checked_cast<int32_t>(right * 1000 / x_scale),
                 pdfium::base::checked_cast<int32_t>(bottom * 1000 / y_scale));
}
...
absl::optional<FX_RECT> CFX_Font::GetGlyphBBox(uint32_t glyph_index) {
  ...
  if (FXFT_Is_Face_Tricky(m_Face->GetRec())) {
    ...
    FX_RECT result = FXRectFromFTPos(cbox.xMin, cbox.yMax, cbox.xMax, cbox.yMin,
  ...
  return FXRectFromFTPos(FXFT_Get_Glyph_HoriBearingX(m_Face->GetRec()),
                         ...
                         FXFT_Get_Glyph_HoriBearingY(m_Face->GetRec()), em, em);
}
...
absl::optional<FX_RECT> CFX_Font::GetRawBBox() const {
  ...
  return FXRectFromFTPos(FXFT_Get_Face_xMin(m_Face->GetRec()),
                         ...
                         FXFT_Get_Face_yMax(m_Face->GetRec()), 0, 0);
}
