...
class CFX_DefaultRenderDevice final : public CFX_RenderDevice {
 public:
  ...
  // These values need to stay updated with respect to public type
  // `FPDF_RENDERER_TYPE`, so that each of that type's value has an appropriate
  // mapping to a value here.
