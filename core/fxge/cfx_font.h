...
class CFX_Font {
 public:
  ...
  uint32_t GetObjectNumber() const { return m_ObjectNumber; }
  uint32_t GetGenerationNumber() const { return m_GenerationNumber; }
 ...
 private:
  ...
  uint32_t m_ObjectNumber = 0;
  uint32_t m_GenerationNumber = 0;
