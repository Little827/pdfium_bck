...
TEST(FXFontTest, PDF_UnicodeFromAdobeName) {
  EXPECT_EQ(0x00b6, PDF_UnicodeFromAdobeName("paragraph"));
  EXPECT_EQ(0x00d3, PDF_UnicodeFromAdobeName("Oacute"));
  EXPECT_EQ(0x00fe, PDF_UnicodeFromAdobeName("thorn"));
  EXPECT_EQ(0x0384, PDF_UnicodeFromAdobeName("tonos"));
  EXPECT_EQ(0x2022, PDF_UnicodeFromAdobeName("bullet"));
}
