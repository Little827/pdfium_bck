...
// of FXFILL_WINDING and FXFILL_WINDING are replaced by
...
// GetIntegerFlagFromFillRenderOptions() once all integer rendering flags are
// replaced with CFX_FillRenderOptions.

// Generates a matching CFX_FillRenderOptions struct from integer |flags| which
// contains fill rendering options.
CFX_FillRenderOptions GetFillRenderOptionsFromIntegerFlag(int flags);
