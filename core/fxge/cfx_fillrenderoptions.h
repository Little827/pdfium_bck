...
// GetFillOptionsFromIntegerFlag() and GetIntegerFlagFromFillOptions() once all
// integer rendering flags are replaced with CFX_FillRenderOptions.

// Generates a matching CFX_FillRenderOptions struct from integer |flags| which
// contains fill rendering options.
CFX_FillRenderOptions GetFillOptionsFromIntegerFlag(int flags);

// Generates an integer which represents fill options from CFX_FillRenderOptions
// struct |options|.
int GetIntegerFlagFromFillOptions(const CFX_FillRenderOptions& options);
