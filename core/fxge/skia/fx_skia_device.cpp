...
class SkiaState {
 public:
  ...
  void FlushText() {
    ...
    if (!m_options.IsSmooth()) {
      font.setEdging(SkFont::Edging::kAlias);
    } else if (m_options.aliasing_type == CFX_TextRenderOptions::kLcd) {
    ...
    m_options = CFX_TextRenderOptions();
  }
 ...
 private:
  ...
  CFX_TextRenderOptions m_options;
...
bool CFX_SkiaDeviceDriver::DrawDeviceText(
  ...
  if (!options.IsSmooth())
    font.setEdging(SkFont::Edging::kAlias);
  if (options.aliasing_type == CFX_TextRenderOptions::kLcd)
    font.setEdging(SkFont::Edging::kSubpixelAntiAlias);
