...
//
// By default(either there is no encode array or the matching encode values for
// pFunc are in increasing order), is_encode_reversed is set to false.
// Otherwise, set is_encode_reversed to true.
//
