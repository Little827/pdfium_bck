  ...
  switch (pSource->GetBPP()) {
    case 1: {
      ...
      if (pSource->GetFormat() == FXDIB_Format::k1bppRgb &&
        ...
        DCHECK(color1 == FXARGB_G(pSource->GetPaletteArgb(0)));
        DCHECK(color1 == FXARGB_B(pSource->GetPaletteArgb(0)));
        DCHECK(color2 == FXARGB_G(pSource->GetPaletteArgb(1)));
        DCHECK(color2 == FXARGB_B(pSource->GetPaletteArgb(1)));
      }
