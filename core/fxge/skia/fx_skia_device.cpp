...
// from a 1 bit-per-pixel source palette. The caller is responsible for checking
// whether `source` is 1 bit-per-pixel.
...
// from `palette`. The caller is responsible for checking whether `source` is 8
// bit-per-pixel.
