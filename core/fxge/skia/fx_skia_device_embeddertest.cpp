...
TEST_F(FxgeSkiaEmbedderTest, RenderBigImageTwice) {
  ...
  NiceMock<MockCanvas> canvas(/*width=*/306, /*height=*/396);
  ...
  RenderPageToSkCanvas(page, /*start_x=*/0, /*start_y=*/0, /*size_x=*/306,
                       /*size_y=*/198, &canvas);
  RenderPageToSkCanvas(page, /*start_x=*/0, /*start_y=*/198, /*size_x=*/306,
                       /*size_y=*/198, &canvas);
