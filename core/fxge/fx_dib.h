...
struct FXDIB_RenderOptions {
  FXDIB_RenderOptions();
  FXDIB_RenderOptions(bool downsample,
                      bool bilinear,
                      bool bicubic,
                      bool halftone,
                      bool no_smoothing,
  ...
  // Returns true if any member is set to true.
...
extern const FXDIB_RenderOptions kBilinearInterpolation;
