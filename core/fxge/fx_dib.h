...
inline uint32_t GetFlagsFromFormat(FXDIB_Format format) {
...
inline FXDIB_Format MakeFormat(int flags, int bpp) {
  switch (flags) {
    case 0:
      switch (bpp) {
        case 1:
    ...
    case 4:
      switch (bpp) {
        case 1:
          return FXDIB_Format::k1bppCmyk;
        case 8:
          return FXDIB_Format::k8bppCmyk;
        case 32:
          return FXDIB_Format::kCmyk;
        default:
          return FXDIB_Format::kInvalid;
      }
    case 6:
