...
// static
void CFX_ImageStretcher::BuildPaletteFrom1BppPaletteColors(
...
bool CFX_ImageStretcher::Start() {
  ...
  if (m_pSource->GetFormat() == FXDIB_Format::k1bppRgb &&
    ...
    FX_ARGB pal[256];
    pdfium::span<FX_ARGB> pal_span(pal, 256);
    BuildPaletteFrom1BppPaletteColors(m_pSource, pal_span);
