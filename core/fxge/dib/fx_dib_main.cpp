...
FXDIB_RenderOptions::FXDIB_RenderOptions() = default;

FXDIB_RenderOptions::FXDIB_RenderOptions(bool downsample,
                                         bool bilinear,
                                         bool bicubic,
                                         bool halftone,
                                         bool no_smoothing,
