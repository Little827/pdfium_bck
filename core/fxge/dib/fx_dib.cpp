...
static_assert(sizeof(FX_RGB_STRUCT<uint8_t>) == 3 * sizeof(uint8_t));
static_assert(sizeof(FX_BGR_STRUCT<uint8_t>) == 3 * sizeof(uint8_t));
static_assert(sizeof(FX_ARGB_STRUCT<uint8_t>) == 4 * sizeof(uint8_t));
static_assert(sizeof(FX_ABGR_STRUCT<uint8_t>) == 4 * sizeof(uint8_t));
static_assert(sizeof(FX_RGBA_STRUCT<uint8_t>) == 4 * sizeof(uint8_t));
static_assert(sizeof(FX_BGRA_STRUCT<uint8_t>) == 4 * sizeof(uint8_t));
static_assert(sizeof(FX_CMYK_STRUCT<uint8_t>) == 4 * sizeof(uint8_t));
