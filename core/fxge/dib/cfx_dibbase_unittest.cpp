...
TEST(CFX_DIBBaseTest, GetOverlapRect) {
  ...
  {
    // Overlap case. The overlap size still fits within both the source and
    // destination.
  ...
  {
    // Overlap case. The overlap size is limited by the source size.
  ...
  {
    // Overlap case. The overlap size is limited by the destination size.
    const Input kInput = {/*src_top_left=*/{35, 41}, /*src_size=*/{400, 300},
                          /*dest_top_left=*/{123, 137},
