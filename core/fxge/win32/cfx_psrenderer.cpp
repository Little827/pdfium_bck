...
CFX_PSRenderer::Glyph::Glyph(CFX_Font* font, uint32_t glyph_index)
    : font(font), glyph_index(glyph_index) {}

CFX_PSRenderer::Glyph::Glyph(const Glyph& other) = default;

CFX_PSRenderer::Glyph::~Glyph() = default;
...
void CFX_PSRenderer::FindPSFontGlyph(CFX_GlyphCache* pGlyphCache,
  ...
  m_PSFontList.push_back(Glyph(pFont, charpos.m_GlyphIndex));
