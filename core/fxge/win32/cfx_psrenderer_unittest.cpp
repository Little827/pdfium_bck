...
TEST(PSRendererTest, GenerateType42SfntData) {
  ...
  const char kExpectedOddByteCountResult[] = R"(/odd_sfnts [
<
002037
>
] def
  ...
  const char kExpectedEvenByteCountResult[] = R"(/even_sfnts [
<
0020424D00
>
] def
...
TEST(PSRendererTest, GenerateType42FontDictionary) {
  ...
  const char kExpected1DescendantFontResult[] = R"(8 dict begin
/FontType 42 def
...
%%EndResource
  ...
  const char kExpected2DescendantFontResult[] = R"(8 dict begin
/FontType 42 def
/FontMatrix [1 0 0 1 0 0] def
