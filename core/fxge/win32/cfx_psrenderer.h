...
class CFX_PSRenderer {
 ...
 private:
  ...
  struct FaxCompressResult {
    FaxCompressResult();
    FaxCompressResult(FaxCompressResult&&);
    FaxCompressResult& operator=(FaxCompressResult&&);
    ~FaxCompressResult();
  ...
  struct PSCompressResult {
    PSCompressResult();
    PSCompressResult(PSCompressResult&&);
    PSCompressResult& operator=(PSCompressResult&&);
    ~PSCompressResult();
