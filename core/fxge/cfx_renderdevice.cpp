...
bool CFX_RenderDevice::DrawPathWithBlend(
  ...
  uint8_t fill_alpha = IsWindingOrEvenOddFillType(fill_options.fill_type)
                           ? FXARGB_A(fill_color)
                           : 0;
  ...
  if (IsWindingOrEvenOddFillType(fill_options.fill_type) && stroke_alpha == 0 &&
      !fill_options.stroke && !fill_options.text_mode) {
  ...
  if (IsWindingOrEvenOddFillType(fill_options.fill_type) && fill_alpha &&
      stroke_alpha < 0xff && fill_options.stroke) {
