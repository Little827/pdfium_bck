...
static const CFX_FillRenderOptions& kEvenOddOptions =
...
void CFX_RenderDevice::DrawFillArea(const CFX_Matrix& mtUser2Device,
  ...
  DrawPath(&path, &mtUser2Device, nullptr, color, 0, kEvenOddOptions);
}
...
void CFX_RenderDevice::DrawStrokeRect(const CFX_Matrix& mtUser2Device,
  ...
  CFX_PathData path;
  path.AppendFloatRect(rect);
  DrawPath(&path, &mtUser2Device, &gsd, 0, color, kEvenOddOptions);
}
...
void CFX_RenderDevice::DrawStrokeLine(const CFX_Matrix* pUser2Device,
  ...
  DrawPath(&path, pUser2Device, &gsd, 0, color, kEvenOddOptions);
}
  ...
  switch (nStyle) {
    ...
    case BorderStyle::kInset: {
      ...
      DrawPath(&path_left_top, pUser2Device, &gsd,
               crLeftTop.ToFXColor(nTransparency), 0, kEvenOddOptions);
      ...
      DrawPath(&path_right_bottom, pUser2Device, &gsd,
               crRightBottom.ToFXColor(nTransparency), 0, kEvenOddOptions);
