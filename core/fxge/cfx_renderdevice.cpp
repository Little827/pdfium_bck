...
#if defined(_SKIA_SUPPORT_) || defined(_SKIA_SUPPORT_PATHS_)
        // Skia rendering follows strictly according to the options that
        // |text_options| provides. Therefore we update |text_options| so that
        // Skia falls back on normal antialiasing as well.
