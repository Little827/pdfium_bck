...
bool FindSimilarNameMatch(const ByteStringView& family_name,
  ...
  // but they match different words. For example: "Univers" and "Universal" are
  // not a match, but "Univers" and "Univers Bold" are a match.
...
void* CFX_FolderFontInfo::FindFont(int weight,
  ...
  for (const auto& it : m_FontList) {
    ...
    if (bMatchName && !FindSimilarNameMatch(bsFamily, bsName))
      continue;
