...
Optional<CFX_ColorTypeAndARGB> CPDF_DefaultAppearance::GetColorARGB() const {
  ...
  if (color.nColorType == CFX_Color::Type::kGray) {
    ...
    return CFX_ColorTypeAndARGB(CFX_Color::Type::kGray,
  ...
  if (color.nColorType == CFX_Color::Type::kRGB) {
    ...
    return CFX_ColorTypeAndARGB(CFX_Color::Type::kRGB,
