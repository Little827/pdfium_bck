...
TEST(cpdf_nametree, GetUnicodeNameWithBOM) {
  ...
  const CPDF_Number* pNumber =
      ToNumber(name_tree->LookupValue(WideString(L"1")));
  ASSERT_TRUE(pNumber);
...
TEST(cpdf_nametree, GetFromTreeWithLimitsArrayWith4Items) {
  ...
  const CPDF_Number* pNumber =
      ToNumber(name_tree->LookupValue(WideString(L"9.txt")));
  ASSERT_TRUE(pNumber);
...
TEST(cpdf_nametree, AddIntoKids) {
  ...
  EXPECT_TRUE(name_tree->AddValueAndName(pdfium::MakeRetain<CPDF_Number>(444),
                                         WideString(L"4.txt")));
  ASSERT_TRUE(name_tree->LookupValue(WideString(L"4.txt")));
  EXPECT_EQ(444, name_tree->LookupValue(WideString(L"4.txt"))->GetInteger());
  ...
  EXPECT_TRUE(name_tree->AddValueAndName(pdfium::MakeRetain<CPDF_Number>(666),
                                         WideString(L"6.txt")));
  ASSERT_TRUE(name_tree->LookupValue(WideString(L"6.txt")));
  EXPECT_EQ(666, name_tree->LookupValue(WideString(L"6.txt"))->GetInteger());
  ...
  EXPECT_TRUE(name_tree->AddValueAndName(pdfium::MakeRetain<CPDF_Number>(99),
                                         WideString(L"99.txt")));
  ASSERT_TRUE(name_tree->LookupValue(WideString(L"99.txt")));
  EXPECT_EQ(99, name_tree->LookupValue(WideString(L"99.txt"))->GetInteger());
  ...
  EXPECT_TRUE(name_tree->AddValueAndName(pdfium::MakeRetain<CPDF_Number>(-5),
                                         WideString(L"0.txt")));
  ASSERT_TRUE(name_tree->LookupValue(WideString(L"0.txt")));
  EXPECT_EQ(-5, name_tree->LookupValue(WideString(L"0.txt"))->GetInteger());
...
TEST(cpdf_nametree, DeleteFromKids) {
  ...
  WideString csName;
  ASSERT_TRUE(name_tree->LookupValue(WideString(L"9.txt")));
  EXPECT_EQ(999, name_tree->LookupValue(WideString(L"9.txt"))->GetInteger());
  ...
  ASSERT_TRUE(name_tree->LookupValue(WideString(L"2.txt")));
  EXPECT_EQ(222, name_tree->LookupValue(WideString(L"2.txt"))->GetInteger());
  ...
  ASSERT_TRUE(name_tree->LookupValue(WideString(L"1.txt")));
  EXPECT_EQ(111, name_tree->LookupValue(WideString(L"1.txt"))->GetInteger());
  ...
  ASSERT_TRUE(name_tree->LookupValue(WideString(L"3.txt")));
  EXPECT_EQ(333, name_tree->LookupValue(WideString(L"3.txt"))->GetInteger());
  EXPECT_TRUE(name_tree->LookupValueAndName(0, &csName));
  ...
  ASSERT_TRUE(name_tree->LookupValue(WideString(L"5.txt")));
  EXPECT_EQ(555, name_tree->LookupValue(WideString(L"5.txt"))->GetInteger());
  EXPECT_TRUE(name_tree->LookupValueAndName(0, &csName));
