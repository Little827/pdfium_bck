...
class CPDF_FormControl {
 public:
  ...
  CFX_ColorTypeAndARGB GetBorderColorARGB() { return GetColorARGB("BC"); }
  ...
  CFX_ColorTypeAndARGB GetBackgroundColor() { return GetColorARGB("BG"); }
 ...
 private:
  ...
  CFX_ColorTypeAndARGB GetColorARGB(const ByteString& csEntry);
