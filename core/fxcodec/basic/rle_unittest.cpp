...
TEST(fxcodec, RLETestEmptyInput) {
...
TEST(fxcodec, RLETestShortInput) {
  ...
  dest_buf = BasicModule::RunLengthEncode(src_buf);
...
TEST(fxcodec, RLETestNormalInputs) {
...

  {
    ...
    dest_buf = BasicModule::RunLengthEncode(src_buf_1);
...

  {
    ...
    dest_buf = BasicModule::RunLengthEncode(src_buf_2);
    decoded_buf.reset();
    decoded_size = 0;
    RunLengthDecode(dest_buf, &decoded_buf, &decoded_size);
...

  {
    ...
    dest_buf = BasicModule::RunLengthEncode(src_buf_3);
    decoded_buf.reset();
    decoded_size = 0;
    RunLengthDecode(dest_buf, &decoded_buf, &decoded_size);
...
TEST(fxcodec, RLETestFullLengthInputs) {
...

  {
    ...
    dest_buf = BasicModule::RunLengthEncode(src_buf_4);
    decoded_buf.reset();
    decoded_size = 0;
    RunLengthDecode(dest_buf, &decoded_buf, &decoded_size);
