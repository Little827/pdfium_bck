...
class CJBig2_Image {
 ...
 private:
  ...
  bool ComposeBothIntrawordLeft(JBig2ComposeOp op,
                                int32_t yLow,
                                int32_t yHi,
                                ...
                                uint32_t shift,
                                uint32_t maskM);
  bool ComposeBothIntrawordRight(JBig2ComposeOp op,
                                 int32_t yLow,
                                 int32_t yHi,
                                 const uint8_t* lineSrc,
                                 uint8_t* lineDst,
                                 ...
                                 uint32_t shift,
                                 uint32_t maskM);
  bool ComposeDstIntraword(JBig2ComposeOp op,
                           int32_t yLow,
                           int32_t yHi,
                           const uint8_t* lineSrc,
                           uint8_t* lineDst,
                           ...
                           uint32_t shift1,
                           uint32_t maskM);
  bool ComposeLeft(JBig2ComposeOp op,
                   int32_t yLow,
                   int32_t yHi,
                   const uint8_t* lineSrc,
                   uint8_t* lineDst,
  ...
  bool ComposeMiddle(JBig2ComposeOp op,
                     int32_t yLow,
                     int32_t yHi,
                     const uint8_t* lineSrc,
                     uint8_t* lineDst,
                     ...
                     int32_t d2,
                     int32_t middleDwords);
  bool ComposeRight(JBig2ComposeOp op,
                    int32_t yLow,
                    int32_t yHi,
                    const uint8_t* lineSrc,
                    uint8_t* lineDst,
