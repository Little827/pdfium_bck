...
const int kOptConstant1[] = {0x9b25, 0x0795, 0x00e5};
const int kOptConstant2[] = {6, 4, 1};
const int kOptConstant3[] = {0xf800, 0x1e00, 0x0380};
const int kOptConstant4[] = {0, 1, 3};
const int kOptConstant5[] = {0x07f0, 0x01f8, 0x007c};
const int kOptConstant6[] = {0x7bf7, 0x1e00, 0x0380};
const int kOptConstant7[] = {0x0800, 0x0200, 0x0080};
const int kOptConstant8[] = {0x0010, 0x0008, 0x0004};
const int kOptConstant9[] = {0x7bf7, 0x0efb, 0x01bd};
    ...
    if (LTP) {
      ...
      if (h > 1) {
        ...
        for (int32_t k = 0; k < nBitsLeft; ++k) {
          ...
          cVal1 |= bVal << (7 - k);
          CONTEXT =
              (((CONTEXT & kOptConstant9[OPT]) << 1) | bVal |
        ...
        for (int32_t k = 0; k < nBitsLeft; ++k) {
          ...
          int bVal = pArithDecoder->Decode(&gbContext[CONTEXT]);
          cVal1 |= bVal << (7 - k);
          CONTEXT = (((CONTEXT & kOptConstant9[OPT]) << 1) | bVal |
