...
//          buffer             - A buffer for holding the returned key in UTF-16LE. This is only
...
// Experimental API.
// Function: FPDF_StructElement_Attr_GetIntValue
//          Get the value of a number attribute in a attribute map by name as int.
//          FPDF_StructElement_Attr_GetType() should have returned FPDF_OBJECT_NUMBER
//          or FPDF_OBJECT_BOOLEAN for this property.
// Parameters:
//          struct_attribute   - Handle to the struct element attribute.
//          name               - The attribute name.
//          out_value          - A pointer to variable that will receive the value. Not filled if
//                              false is returned.
// Return value:
...
//          Get the value of a number attribute in a attribute map by name as float.
//          FPDF_StructElement_Attr_GetType() should have returned FPDF_OBJECT_NUMBER
//          for this property.
// Parameters:
//          struct_attribute   - Handle to the struct element attribute.
...
//          Get the value of a string attribute in a attribute map by name as string.
//          FPDF_StructElement_Attr_GetType() should have returned FPDF_OBJECT_STRING or
//          FPDF_OBJECT_NAME for this property.
// Parameters:
//          struct_attribute   - Handle to the struct element attribute.
//          name               - The attribute name.
//          buffer             - A buffer for holding the returned key in UTF-16LE. This is only
...
//          Get the value of a blob attribute in a attribute map by name as string.
// Parameters:
//          struct_attribute   - Handle to the struct element attribute.
//          name               - The attribute name.
//          buffer             - A buffer for holding the returned key in UTF-16LE. This is only
