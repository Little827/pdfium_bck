...
//           NULL character. The number of bytes is returned regardless of the
//           |buffer| and |buflen| parameters.
// Comments:
//           Regardless of the platform, the |buffer| is always in UTF-16LE
//           encoding. The string is terminated by a UTF16 NUL character. If
...
//          Get the value of a number attribute in a attribute map by name as
//          int. FPDF_StructElement_Attr_GetType() should have returned
//          FPDF_OBJECT_NUMBER or FPDF_OBJECT_BOOLEAN for this property.
// Parameters:
//          struct_attribute   - Handle to the struct element attribute.
//          name               - The attribute name.
...
//          Get the value of a string attribute in a attribute map by name as
...
//          Get the value of a blob attribute in a attribute map by name as
//          string.
// Parameters:
//          struct_attribute   - Handle to the struct element attribute.
//          name               - The attribute name.
