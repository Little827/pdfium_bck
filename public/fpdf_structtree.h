...
// Return value:
//          A handle to the structure tree or NULL on error. The caller owners
//          the returned handle and must use FPDF_StructTree_Close() to release
//          it. The handle should be released before |page| gets released.
