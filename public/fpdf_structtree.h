...
// Experimental API.
// Function: FPDF_StructElement_GetAlternateText
...
FPDF_StructElement_GetAlternateText(FPDF_STRUCTELEMENT struct_element,
                                    void* buffer,
...
// Experimental API.
// Function: FPDF_StructElement_GetElementType
...
//           |buffer| will not be modified.
FPDF_EXPORT unsigned long FPDF_CALLCONV
FPDF_StructElement_GetElementType(FPDF_STRUCTELEMENT struct_element,
                                  void* buffer,
                                  unsigned long buflen);
...
// Experimental API.
// Function: FPDF_StructElement_GetElementTitle
...
//           |buffer| will not be modified.
FPDF_EXPORT unsigned long FPDF_CALLCONV
FPDF_StructElement_GetElementTitle(FPDF_STRUCTELEMENT struct_element,
                                   void* buffer,
                                   unsigned long buflen);
