...
//          progressively with a specified or default color scheme for
//          the content if the FPDF_FORCEDCOLOR is set in |flags|.
// Parameters:
...
//          color_scheme -   Color scheme to be used when forced color is
//                           enabled. This value is optional, but if the value
//                           is null with FPDF_FORCEDCOLOR flag enabled, the
