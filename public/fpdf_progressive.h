...
//          color_scheme-   Color scheme to be used when forced color
//                          is enabled. If not present with FPDF_FORCEDCOLOR
//                          flag enabled, the default color scheme will be used
