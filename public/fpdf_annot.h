...
// use with listbox and combobox widget annotations. On error, return value
// will be 0.
//
//   annot  - handle to an annotation.
//
// Returns the number of options in "Opt" dictionary.
...
// will be added to |buffer| and the return value will be 0.
//
//   annot  - handle to an annotation.
