...
// Experimental API.
// Set the list of focusable annotation subtype. Annotations of subtype widget
// are by default focusable. New subtypes set using this API will not override
// the existing subtypes.
//
//   hHandle  - handle to the form fill module, returned by
//              FPDFDOC_InitFormFillEnvironment.
...
// Note : Annotations of type WIDGET are by default focusable.
FPDF_EXPORT int FPDF_CALLCONV
