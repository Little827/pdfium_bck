...
// Experimental API.
// Get the count of annotations in the |annot|'s control group.
...
// Experimental API.
// Get the index of |annot| in |annot|'s control group.
// A group of interactive form annotations is collectively called a form
// control group. Here, |annot|, an interactive form annotation, should be
// either a radio button or a checkbox.
//
...
// Experimental API.
// Gets the label of |annot| which is an interactive form annotation.
...
//    buflen      -   length of the buffer in bytes.
//
// Returns the length of the string label in bytes.
FPDF_EXPORT unsigned long FPDF_CALLCONV
