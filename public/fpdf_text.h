...
//            flags     - Pointer to an int receiving the font flags. These
//            flags should be interpreted per spec 1.7 Section 5.7.1 Font
//            Descriptor Flags.
// Return value:
//            On success, return the length of the font name, including the
//            trailing NUL character. If this length is less than or equal to
//            |length|, |buffer| is set to the font name, |flags| is set to
//            the font flags. |buffer| is always in UTF-8 encoding. Return 0 on
//            failure.
