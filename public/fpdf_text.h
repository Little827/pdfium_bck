...
// Experimental API.
// Function: FPDFText_IsInvalidUnicode
...
//          index       -   Zero-based index of the character.
// Return value:
//          1 if the character definitely has an invalid unicode mapping.
//          0 if the character has no known unicode mapping issues.
//          -1 if there was an error.
//
FPDF_EXPORT int FPDF_CALLCONV
FPDFText_IsInvalidUnicode(FPDF_TEXTPAGE text_page, int index);
