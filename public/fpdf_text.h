...
//                          fill color value.
//          is_rendered -   Pointer to a boolean value receiving if the fill is
//                          rendered.
// Return value:
//          Whether the call succeeded. If false, |color| and |is_rendered| are
//          unchanged.
//
...
//          color       -   Pointer to an unsigned int number receiving the
//                          stroke color value.
//          is_rendered -   Pointer to a boolean value receiving if the stroke
//                          is rendered.
// Return value:
//          Whether the call succeeded. If false, |color| and |is_rendered| are
//          unchanged.
