...
//                          encoded in UTF-8.
//          buffer      -   Caller-provided buffer to receive key, or NULL to
//                          query required length.
//          length      -   Length of the buffer, or 0 when |buffer| is NULL.
// Return value:
...
//          as when |document| is invalid. If |length| is less than the returned
//          length, |buffer| not be modified.
FPDF_EXPORT unsigned long FPDF_CALLCONV
