...
//          Returns a string of command line flags that are recommended to be
//          passed into V8 prior to initalizing PDFium library.
// Parameters:
//          None.
// Return value:
//          NUL-termnated string containing --flags for v8. The caller must not
//          attempt to modify or free the result.
