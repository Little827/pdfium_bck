...
typedef struct fpdf_recorder_t__* FPDF_RECORDER;
typedef struct fpdf_schandle_t__* FPDF_SCHHANDLE;
...
typedef const struct fpdf_pathsegment_t__* FPDF_PATHSEGMENT;
