...
// PDF renderers
typedef enum {
  FPDF_RENDERTYPE_DEFAULT = 0,  // Default from build configuration.
  FPDF_RENDERERTYPE_AGG = 1,
  FPDF_RENDERERTYPE_SKIA = 2,
  FPDF_RENDERERTYPE_SKIAPATHS = 3,
  FPDF_RENDERERMODE_LAST = FPDF_RENDERERTYPE_SKIAPATHS,
} FPDF_RENDERER_TYPE;
