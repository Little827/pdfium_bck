...
#define FPDF_THUMBNAIL_BITMAP 0
#define FPDF_THUMBNAIL_RAW_STREAM 1
#define FPDF_THUMBNAIL_DECODED_STREAM 2
...
// size of the decoded data. Returns the size of the uncompressed
...
// Experimental API.
// Returns the thumbnail of |page| as a FPDFBitmap. Returns a nullptr
// if unable to access the thumbnail's stream or if its decoded data
// is 0 bytes long.
//
//   page - handle to a page.
