...
enum ThumbnailType { kBitmap = 0, kRawStream = 1, kDecodedStream = 2 };
...
bool GetThumbnailFilename(char* name_buf,
  ...
  switch (thumbnail_type) {
    case ThumbnailType::kBitmap:
      format = "%s.thumbnail.%d.png";
      break;
    case ThumbnailType::kDecodedStream:
      format = "%s.thumbnail.decoded.%d.b";
      break;
    case ThumbnailType::kRawStream:
