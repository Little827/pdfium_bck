...
constexpr char kUsageString[] =
    ...
    "  --lcd_text           - render text optimized for LCD displays\n"
    "  --no_nativetext      - render without using the native text output\n"
    "  --grayscale          - render grayscale output\n"
    "  --limit-cache        - render limiting image cache size\n"
    "  --force_halftone     - render forcing halftone\n"
    "  --printing           - render as if for printing\n"
    "  --no_smoothtext      - render disabling text anti-aliasing\n"
    "  --no_smoothimage     - render disabling image anti-alisasing\n"
    "  --no_smoothpath      - render disabling path anti-aliasing\n"
