...
void SendActionHandler(FPDF_MetricsHandler* handler, FPDF_WIDESTRING action) {
  printf("Metric Action: %ls\n", GetPlatformWString(action).c_str());
}
...
int main(int argc, const char* argv[]) {
  ...
  if (options.show_metrics) {
    ...
    metrics_handler.SendAction = SendActionHandler;
