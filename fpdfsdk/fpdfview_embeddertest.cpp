...
TEST_F(FPDFViewEmbeddertest, FPDF_RenderPageBitmapWithMatrix) {
  ...
  FPDF_RenderPageBitmapWithMatrix(bitmap, page, &identity_matrix, &page_rect,
                                  0);
  CompareBitmap(bitmap, page_width, page_height, kOriginalMD5);
  WriteBitmapToPng(bitmap, "original.png");
  FPDFBitmap_Destroy(bitmap);
  ...
  WriteBitmapToPng(bitmap, "clipped.png");
  FPDFBitmap_Destroy(bitmap);
  ...
  WriteBitmapToPng(bitmap, "top_left_quarter.png");
  FPDFBitmap_Destroy(bitmap);
  ...
  WriteBitmapToPng(bitmap, "trimmed.png");
  FPDFBitmap_Destroy(bitmap);
  ...
  WriteBitmapToPng(bitmap, "rotated_same.png");
  FPDFBitmap_Destroy(bitmap);
  ...
  WriteBitmapToPng(bitmap, "larger_top_left_quarter.png");
  FPDFBitmap_Destroy(bitmap);
  ...
  WriteBitmapToPng(bitmap, "larger.png");
  FPDFBitmap_Destroy(bitmap);
  ...
  WriteBitmapToPng(bitmap, "larger_clipped.png");
  FPDFBitmap_Destroy(bitmap);
  ...
  WriteBitmapToPng(bitmap, "larger_rotated.png");
  FPDFBitmap_Destroy(bitmap);
  ...
  WriteBitmapToPng(bitmap, "larger_rotated_landscape.png");
  FPDFBitmap_Destroy(bitmap);
  ...
  WriteBitmapToPng(bitmap, "larger_rotated_diagonal.png");
  FPDFBitmap_Destroy(bitmap);
  ...
  WriteBitmapToPng(bitmap, "tile.png");
  FPDFBitmap_Destroy(bitmap);
