...
TEST_F(FPDFTextEmbedderTest, GetFillColor) {
  ...
  ASSERT_FALSE(FPDFText_GetFillColor(nullptr, 0, nullptr, nullptr, nullptr));
  ASSERT_FALSE(FPDFText_GetFillColor(text_page, -1, nullptr, nullptr, nullptr));
  ASSERT_FALSE(
      FPDFText_GetFillColor(text_page, 314, nullptr, nullptr, nullptr));
  ASSERT_FALSE(FPDFText_GetFillColor(text_page, 0, nullptr, nullptr, nullptr));

  int r;  // Expected to be 0xFF.
  int g;  // Expected to be 0.
  int b;  // Expected to be 0.
  ASSERT_TRUE(FPDFText_GetFillColor(text_page, 0, &r, &g, &b));
  ASSERT_EQ(0xFF, r);
  ASSERT_EQ(0, g);
  ASSERT_EQ(0, b);
...
TEST_F(FPDFTextEmbedderTest, GetStrokeColor) {
  ...
  ASSERT_FALSE(FPDFText_GetStrokeColor(nullptr, 0, nullptr, nullptr, nullptr));
  ASSERT_FALSE(
      FPDFText_GetStrokeColor(text_page, -1, nullptr, nullptr, nullptr));
  ASSERT_FALSE(
      FPDFText_GetStrokeColor(text_page, 314, nullptr, nullptr, nullptr));
  ASSERT_FALSE(
      FPDFText_GetStrokeColor(text_page, 0, nullptr, nullptr, nullptr));

  int r;  // Expected to be 0xFF.
  int g;  // Expected to be 0.
  int b;  // Expected to be 0.
  ASSERT_TRUE(FPDFText_GetStrokeColor(text_page, 0, &r, &g, &b));
  ASSERT_EQ(0, r);
  ASSERT_EQ(0xFF, g);
  ASSERT_EQ(0, b);
