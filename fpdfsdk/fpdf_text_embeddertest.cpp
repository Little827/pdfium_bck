...
TEST_F(FPDFTextEmbedderTest, GetCharAngle) {
  ...
  EXPECT_NEAR(pdfium::base::kPiFloat / 4, FPDFText_GetCharAngle(text_page, 0),
              0.001);
  EXPECT_NEAR(3.0f * pdfium::base::kPiFloat / 4,
              FPDFText_GetCharAngle(text_page, kSubstringsSize[0]), 0.001);
  EXPECT_NEAR(
      5.0f * pdfium::base::kPiFloat / 4,
      FPDFText_GetCharAngle(text_page, kSubstringsSize[0] + kSubstringsSize[1]),
      0.001);
  EXPECT_NEAR(
      7.0f * pdfium::base::kPiFloat / 4,
      FPDFText_GetCharAngle(text_page, kSubstringsSize[0] + kSubstringsSize[1] +
                                           kSubstringsSize[2]),
      0.001);
