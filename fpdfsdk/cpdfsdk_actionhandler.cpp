...
bool CPDFSDK_ActionHandler::IsValidField(
  ...
  return !!pPDFInteractiveForm->GetFieldByDict(pFieldDict);
}
...
bool CPDFSDK_ActionHandler::DoAction_Hide(
  ...
  CPDFSDK_InteractiveForm* pInteractiveForm =
      pFormFillEnv->GetInteractiveForm();
  if (pInteractiveForm->DoAction_Hide(action)) {
...
bool CPDFSDK_ActionHandler::DoAction_SubmitForm(
  ...
  CPDFSDK_InteractiveForm* pInteractiveForm =
      pFormFillEnv->GetInteractiveForm();
  return pInteractiveForm->DoAction_SubmitForm(action);
}
...
void CPDFSDK_ActionHandler::DoAction_ResetForm(
  ...
  CPDFSDK_InteractiveForm* pInteractiveForm =
      pFormFillEnv->GetInteractiveForm();
  pInteractiveForm->DoAction_ResetForm(action);
}
