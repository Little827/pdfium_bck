...
TEST_F(FPDFEditPageEmbedderTest, GetBoundsForNormalText) {
  ...
  EXPECT_FLOAT_EQ(kExpectedTop, quad.y1);
  EXPECT_FLOAT_EQ(kExpectedRight, quad.x2);
  EXPECT_FLOAT_EQ(kExpectedTop, quad.y2);
  EXPECT_FLOAT_EQ(kExpectedRight, quad.x3);
  EXPECT_FLOAT_EQ(kExpectedBottom, quad.y3);
  EXPECT_FLOAT_EQ(kExpectedLeft, quad.x4);
  EXPECT_FLOAT_EQ(kExpectedBottom, quad.y4);
...
TEST_F(FPDFEditPageEmbedderTest, GetBoundsForRotatedText) {
  ...
  float top;
  ASSERT_TRUE(FPDFPageObj_GetBounds(obj, &left, &bottom, &right, &top));
  EXPECT_FLOAT_EQ(98.9478f, left);
  EXPECT_FLOAT_EQ(78.2607f, bottom);
  EXPECT_FLOAT_EQ(126.32983f, right);
  EXPECT_FLOAT_EQ(105.64272f, top);

  FS_QUADPOINTSF quad;
  ASSERT_TRUE(FPDFPageObj_GetRotatedBounds(obj, &quad));
  EXPECT_FLOAT_EQ(106.13486f, quad.x1);
  EXPECT_FLOAT_EQ(105.64272f, quad.y1);
  EXPECT_FLOAT_EQ(126.32983f, quad.x2);
  EXPECT_FLOAT_EQ(85.447739f, quad.y2);
  EXPECT_FLOAT_EQ(119.14279f, quad.x3);
  EXPECT_FLOAT_EQ(78.2607f, quad.y3);
  EXPECT_FLOAT_EQ(98.9478f, quad.x4);
  EXPECT_FLOAT_EQ(98.4557f, quad.y4);
...
TEST_F(FPDFEditPageEmbedderTest, GetBoundsForRotatedImage) {
  ...
  float top;
  ASSERT_TRUE(FPDFPageObj_GetBounds(obj, &left, &bottom, &right, &top));
  EXPECT_FLOAT_EQ(100.0f, left);
  EXPECT_FLOAT_EQ(70.0f, bottom);
  EXPECT_FLOAT_EQ(170.0f, right);
  EXPECT_FLOAT_EQ(140.0f, top);

  FS_QUADPOINTSF quad;
  ASSERT_TRUE(FPDFPageObj_GetRotatedBounds(obj, &quad));
  EXPECT_FLOAT_EQ(140.0f, quad.x1);
  EXPECT_FLOAT_EQ(140.0f, quad.y1);
  EXPECT_FLOAT_EQ(170.0f, quad.x2);
  EXPECT_FLOAT_EQ(110.0f, quad.y2);
  EXPECT_FLOAT_EQ(130.0f, quad.x3);
  EXPECT_FLOAT_EQ(70.0, quad.y3);
  EXPECT_FLOAT_EQ(100.0f, quad.x4);
  EXPECT_FLOAT_EQ(100.0f, quad.y4);
