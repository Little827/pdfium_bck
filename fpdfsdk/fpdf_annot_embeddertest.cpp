...
#if defined(OS_WIN)
const char kAnnotationStampWithApChecksum[] = "xxx4";
...
#if defined(_SKIA_SUPPORT_) || defined(_SKIA_SUPPORT_PATHS_)
#if defined(OS_WIN)
  static const char kMd5ModifiedPath[] = "xxxx0";
  static const char kMd5TwoPaths[] = "xxxx1";
  static const char kMd5NewAnnot[] = "xxxx2";
#elif defined(OS_MACOSX)
