...
TEST_F(FPDFAnnotEmbedderTest, PolygonAnnotation) {
...

  {
    ...
    EXPECT_EQ(159.0f, vertices_buffer[0].x);
    EXPECT_EQ(296.0f, vertices_buffer[0].y);
    EXPECT_EQ(350.0f, vertices_buffer[1].x);
    EXPECT_EQ(411.0f, vertices_buffer[1].y);
    EXPECT_EQ(472.0f, vertices_buffer[2].x);
    EXPECT_EQ(243.42f, vertices_buffer[2].y);
...

  {
    ...
    EXPECT_EQ(size,
              FPDFAnnot_GetVertices(annot.get(), vertices_buffer.data(), size));
    EXPECT_EQ(259.0f, vertices_buffer[0].x);
    EXPECT_EQ(396.0f, vertices_buffer[0].y);
    EXPECT_EQ(450.0f, vertices_buffer[1].x);
    EXPECT_EQ(511.0f, vertices_buffer[1].y);
    EXPECT_EQ(572.0f, vertices_buffer[2].x);
    EXPECT_EQ(343.0f, vertices_buffer[2].y);
  }
