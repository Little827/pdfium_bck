...
// TODO(crbug.com/pdfium/1569): Fix this issue and enable this test for Skia.
#if !defined(_SKIA_SUPPORT_)
TEST_F(FPDFAnnotEmbedderTest, ModifyRectQuadpointsWithAP) {
#if defined(_SKIA_SUPPORT_PATHS_)
#if defined(OS_WIN)
  static const char kMd5Original[] = "xxx1";
  static const char kMd5ModifiedHighlight[] = "xxx2";
  static const char kMd5ModifiedSquare[] = "xxx3";
#else
