...
TEST_F(FPDFAnnotEmbeddertest, GetAndSetQuadPoints) {
  ...
  // Getting quadpoints at out-of-bound index should fail
  ...
  {
    // Check that attempting to add quadpoints would fail
    ...
    EXPECT_FALSE(FPDFAnnot_AppendAttachmentPoints(squareAnnot, &quadpoints));
  }
