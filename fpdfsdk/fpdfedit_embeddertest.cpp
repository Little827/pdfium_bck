...
// Show what the original file looks like.
#if _FX_PLATFORM_ == _FX_PLATFORM_APPLE_
  const char kOriginalMD5[] = "mac md5 before";
#elif _FX_PLATFORM_ == _FX_PLATFORM_WINDOWS_
  const char kOriginalMD5[] = "windwos md5 before";
#else
  ...
  EXPECT_EQ(11u, FPDFPage_CountObjects(page));

#if _FX_PLATFORM_ == _FX_PLATFORM_APPLE_
  const char kNonPrimesMD5[] = "mac md5 after";
#elif _FX_PLATFORM_ == _FX_PLATFORM_WINDOWS_
  const char kNonPrimesMD5[] = "windows md5 after";
#else
