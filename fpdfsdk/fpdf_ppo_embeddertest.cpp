...
TEST_F(FPDFPPOEmbedderTest, BUG_1229106) {
  ...
  static const char kRectsMd5sum[] = "140d629b3c96a07ced2e3e408ea85a1d";
  static const char kBadTwoUpMd5sum[] = "1d12f824e6e1710a91bbb13a903e300a";
  static const char kGoodTwoUpMd5sum[] = "fa4501562301b2e75da354bd067495ec";
  ...
  for (int i = 0; i < kPageCount; ++i) {
    FPDF_PAGE page = LoadPage(0);
    ScopedFPDFBitmap bitmap = RenderLoadedPage(page);
    CompareBitmap(bitmap.get(), 792, 612, kRectsMd5sum);
    UnloadPage(page);
  }
  ...
  for (int i = 0; i < kTwoUpPageCount; ++i) {
    ...
    CompareBitmap(bitmap.get(), 612, 792,
                  i == 0 ? kBadTwoUpMd5sum : kGoodTwoUpMd5sum);
  }
}
