...
const char* RectanglesMultiPagesExpectedChecksum(int page_index) {
  if (CFX_DefaultRenderDevice::SkiaIsDefaultRenderer() ||
    ...
    static const char* checksums1[kRectanglesMultiPagesPageCount] = {
        "7a4cddd5a17a60ce50acb53e318d94f8", "4fa6a7507e9f3ef4f28719a7d656c3a5"};
    return checksums1[page_index];
  }
  static constexpr const char* checksums2[kRectanglesMultiPagesPageCount] = {
      "72d0d7a19a2f40e010ca6a1133b33e1e", "fb18142190d770cfbc329d2b071aee4d"};
  return checksums2[page_index];
}
...
const char* Bug750568PageHash(int page_index) {
  ...
  if (CFX_DefaultRenderDevice::SkiaIsDefaultRenderer() ||
      CFX_DefaultRenderDevice::SkiaPathsIsDefaultRenderer()) {
    static constexpr const char* checksums1[kBug750568PageCount] = {
  ...
  static constexpr const char* checksums2[kBug750568PageCount] = {
