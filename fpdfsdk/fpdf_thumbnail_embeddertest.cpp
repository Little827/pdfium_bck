...
TEST_F(FPDFThumbnailEmbedderTest, GetEncodedThumbnailDataFromPage) {
...

  {
    ...
    EXPECT_EQ(987u,
              FPDFPage_GetEncodedThumbnailDataFromPage(page, buffer, kBufLen));
    EXPECT_EQ(kHashedEncodedData, GenerateMD5Base16(buffer, 987));
...

  {
    ...
    EXPECT_EQ(1218u,
              FPDFPage_GetEncodedThumbnailDataFromPage(page, buffer, kBufLen));
    EXPECT_EQ(kHashedEncodedData, GenerateMD5Base16(buffer, 1218));
...

  {
    ...
    EXPECT_EQ(1275u,
              FPDFPage_GetEncodedThumbnailDataFromPage(page, buffer, kBufLen));
    EXPECT_EQ(kHashedEncodedData, GenerateMD5Base16(buffer, 1275));
