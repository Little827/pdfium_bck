...
TEST_F(FPDFThumbnailEmbedderTest, GetRawThumbnailDataFromPage) {
...

  {
    ...
    EXPECT_EQ(987u,
              FPDFPage_GetRawThumbnailDataFromPage(page, buf, sizeof(buf)));
    EXPECT_EQ(kHashedRawData, GenerateMD5Base16(buf, 987));
...

  {
    ...
    EXPECT_EQ(1218u,
              FPDFPage_GetRawThumbnailDataFromPage(page, buf, sizeof(buf)));
    EXPECT_EQ(kHashedRawData, GenerateMD5Base16(buf, 1218));
...

  {
    ...
    EXPECT_EQ(1275u,
              FPDFPage_GetRawThumbnailDataFromPage(page, buf, sizeof(buf)));
    EXPECT_EQ(kHashedRawData, GenerateMD5Base16(buf, 1275));
