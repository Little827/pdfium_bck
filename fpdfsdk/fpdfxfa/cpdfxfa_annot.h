...
class CPDFXFA_WidgetAnnot final : public CPDFSDK_Annot {
 public:
  CPDFXFA_WidgetAnnot(CXFA_FFWidget* pAnnot,
                      CPDFSDK_PageView* pPageView,
                      CPDFSDK_InteractiveForm* pInteractiveForm);
  ~CPDFXFA_WidgetAnnot() override;
...
inline CPDFXFA_WidgetAnnot* ToXFAWidget(CPDFSDK_Annot* pAnnot) {
  return pAnnot && pAnnot->GetAnnotSubtype() == CPDF_Annot::Subtype::XFAWIDGET
             ? static_cast<CPDFXFA_WidgetAnnot*>(pAnnot)
             : nullptr;
}
