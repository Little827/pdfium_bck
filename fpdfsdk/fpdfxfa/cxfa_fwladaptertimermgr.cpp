...
std::vector<std::unique_ptr<CFWL_TimerInfo>>* s_TimerArray = nullptr;
...
void CXFA_FWLAdapterTimerMgr::Stop(CFWL_TimerInfo* pTimerInfo) {
  ...
  auto it = std::find(s_TimerArray->begin(), s_TimerArray->end(), fake);
