...
CPDFSDK_AnnotIterator::CPDFSDK_AnnotIterator(CPDFSDK_PageView* pPageView,
    ...
    : m_pPageView(pPageView),
      subtypes_to_iterate_(1, nAnnotSubtype),
...
bool CPDFSDK_AnnotIterator::ShouldIterateOverAnnot(
  ...
  auto iter = std::find(subtypes_to_iterate_.begin(),
                        subtypes_to_iterate_.end(), annot_type);
  return iter != subtypes_to_iterate_.end();
}
