...
inline FPDF_ATTACHMENT FPDFAttachmentFromCPDFDictionary(
    CPDF_Dictionary* attachment) {
  return reinterpret_cast<FPDF_ATTACHMENT>(attachment);
}
inline CPDF_Dictionary* CPDFDictionaryFromFPDFAttachment(
    FPDF_ATTACHMENT attachment) {
  return reinterpret_cast<CPDF_Dictionary*>(attachment);
}
