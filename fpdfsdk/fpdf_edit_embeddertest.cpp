...
const char kLoadedFontTextChecksumSkia[] = "fc2334c350cbd0d2ae6076689da09741";
#if BUILDFLAG(IS_APPLE)
...
#if BUILDFLAG(IS_APPLE)
  const char kChecksumSkia[] = "9a31fb87d1c6d2346bba22d1196041cd";
#else   // BUILDFLAG(IS_APPLE)
  const char kChecksumSkia[] = "5bb65e15fc0a685934cd5006dec08a76";
#endif  // BUILDFLAG(IS_APPLE)
  const char kChecksumAgg[] = "9a31fb87d1c6d2346bba22d1196041cd";
...
TEST_F(FPDFEditEmbedderTest, AddTrueTypeFontText) {
  ...
  const char kInsertTrueTypeChecksumSkia[] = "4f9a6c7752ac7d4e4c731260fdb5af15";
#if BUILDFLAG(IS_APPLE)
...
TEST_F(FPDFEditEmbedderTest, AddCIDFontText) {
  ...
  static constexpr char kMd5Skia[] = "2e174d17de96a760d42ca3a06acbf36a";
  static constexpr char kMd5Agg[] = "84d31d11b76845423a2cfc1879c0fbb9";
  const char* kMd5 =
      CFX_DefaultRenderDevice::SkiaIsDefaultRenderer() ? kMd5Skia : kMd5Agg;
  {
    ScopedFPDFBitmap page_bitmap = RenderPage(page);
