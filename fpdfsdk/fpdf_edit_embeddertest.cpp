...
class FPDFEditReorderEmbedderTest
 ...
 public:
  std::string HashForPage(int pageno) {
    std::cout << "WHEEEEE getting hash for pageno " << pageno << "\n";
...
TEST_P(FPDFEditReorderEmbedderTest, MovePagesTest) {
  ...
  FPDFPage_Reorder(et_.document_, &params.dest_page_order[0],
                   static_cast<int>(params.dest_page_order.size()));
  page_count = params.dest_page_order.size();  // page(s) mav have been deleted
  for (int i = 0; i < page_count; i++) {
    std::string hash = HashForPage(i);
...
FPDFEditReorderEmbedderTestCase move_pages_test_cases[] = {{{0, 1, 2, 3, 4}},
                                                           {{0, 2, 4, 3}},
                                                           {{2, 3, 1, 4, 0}},
                                                           {{4, 2}},
                                                           {{3}}};
