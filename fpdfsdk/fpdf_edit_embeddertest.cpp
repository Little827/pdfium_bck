...
TEST_F(FPDFEditEmbedderTest, GetImageMetadata) {
  ...
  EXPECT_EQ(FPDF_COLORSPACE_UNKNOWN,
            static_cast<CPDF_ColorSpace*>(metadata.colorspace)->GetFamily());
  ...
  EXPECT_EQ(FPDF_COLORSPACE_INDEXED,
            static_cast<CPDF_ColorSpace*>(metadata.colorspace)->GetFamily());
  ...
  EXPECT_EQ(FPDF_COLORSPACE_DEVICERGB,
            static_cast<CPDF_ColorSpace*>(metadata.colorspace)->GetFamily());
