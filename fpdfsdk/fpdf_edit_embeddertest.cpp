...
TEST_F(FPDFEditEmbeddertest, RemoveExistingPageObjectSplitStreamsNotLonely) {
  ...
  ASSERT_EQ(2, FPDFPage_CountObjects(page));
#if _FX_PLATFORM_ == _FX_PLATFORM_APPLE_
  const char kHelloRemovedMD5[] = "kHelloRemovedMD5_osx";
#elif _FX_PLATFORM_ == _FX_PLATFORM_WINDOWS_
  const char kHelloRemovedMD5[] = "kHelloRemovedMD5_win";
#else
...
TEST_F(FPDFEditEmbeddertest, RemoveExistingPageObjectSplitStreamsLonely) {
  ...
  ASSERT_EQ(2, FPDFPage_CountObjects(page));
#if _FX_PLATFORM_ == _FX_PLATFORM_APPLE_
  const char kGreetingsRemovedMD5[] = "kGreetingsRemovedMD5_osx";
#elif _FX_PLATFORM_ == _FX_PLATFORM_WINDOWS_
  const char kGreetingsRemovedMD5[] = "kGreetingsRemovedMD5_win";
#else
