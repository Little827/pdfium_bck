...
#if _FX_PLATFORM_ == _FX_PLATFORM_APPLE_
  const char kAllRemovedMD5[] = "kAllRemovedMD5_mac";
#elif _FX_PLATFORM_ == _FX_PLATFORM_WINDOWS_
  const char kAllRemovedMD5[] = "kAllRemovedMD5_win";
#else
...
#if _FX_PLATFORM_ == _FX_PLATFORM_APPLE_
  const char kFirstRemovedMD5[] = "kFirstRemovedMD5_mac";
#elif _FX_PLATFORM_ == _FX_PLATFORM_WINDOWS_
  const char kFirstRemovedMD5[] = "kFirstRemovedMD5_win";
#else
...
#if _FX_PLATFORM_ == _FX_PLATFORM_APPLE_
  const char kLastRemovedMD5[] = "kLastRemovedMD5_mac";
#elif _FX_PLATFORM_ == _FX_PLATFORM_WINDOWS_
  const char kLastRemovedMD5[] = "kLastRemovedMD5_win";
#else
