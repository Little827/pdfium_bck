...
constexpr char kRedRectangleMD5[] = "66d02eaa6181e2c069ce2ea99beda497";

#if defined(OS_MACOSX)
constexpr char kHelloWorldRemovedMD5[] = "17ca3778fd8bb395b46532f1fa17f702";
#elif defined(OS_WIN)
constexpr char kHelloWorldRemovedMD5[] = "aae6c5334721f90ec30d3d59f4ef7deb";
#else
constexpr char kHelloWorldRemovedMD5[] = "b76df015fe88009c3c342395df96abf1";
#endif
...
TEST_F(FPDFEditEmbedderTest, MAYBE_RemovePageObject) {
  ...
  {
    ScopedFPDFBitmap page_bitmap = RenderPage(page);
    CompareBitmap(page_bitmap.get(), 200, 200, fpdfsdk::kHelloWorldOriginalMD5);
  }
  ...
  {
    ScopedFPDFBitmap page_bitmap = RenderPage(page);
    CompareBitmap(page_bitmap.get(), 200, 200, kHelloWorldRemovedMD5);
  }
  ASSERT_EQ(1, FPDFPage_CountObjects(page));
...
TEST_F(FPDFEditEmbedderTest, MAYBE_RemoveExistingPageObjectSplitStreamsLonely) {
  ...
  ASSERT_EQ(2, FPDFPage_CountObjects(page));
  const char* kGreetingsRemovedMD5 = fpdfsdk::kHelloWorldOriginalMD5;
  {
    ScopedFPDFBitmap page_bitmap = RenderPage(page);
...
TEST_F(FPDFEditEmbedderTest, MAYBE_InsertAndRemoveLargeFile) {
  ...
  {
    ScopedFPDFBitmap page_bitmap = RenderPage(page);
    CompareBitmap(page_bitmap.get(), 200, 300,
                  fpdfsdk::kManyRectanglesOriginalMD5);
  }
...
TEST_F(FPDFEditEmbedderTest, AddAndRemovePaths) {
  ...
  {
    ScopedFPDFBitmap page_bitmap = RenderPage(page);
    CompareBitmap(page_bitmap.get(), 612, 792, fpdfsdk::kBlankPage612By792MD5);
  }
  ASSERT_EQ(0, FPDFPage_CountObjects(page));
