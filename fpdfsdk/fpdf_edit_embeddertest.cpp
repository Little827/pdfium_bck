...
#if defined(_SKIA_SUPPORT_) || defined(_SKIA_SUPPORT_PATHS_)
#if defined(OS_WIN)
  const char kOrigMd5sum[] = "d511cae0c8ec3e7b2e7b672485a45859";
#else
...
#else
#if defined(OS_WIN)
  const char kOrigMd5sum[] = "9993d8fd85dfc1f9522c4e5f1533ed78";
  const char kNewMd5sum[] = "ba6450c9060786c5aca3b7552ba7ec9e";
#elif defined(OS_APPLE)
  const char kOrigMd5sum[] = "98c13e90ec592eea79b6458c0ca2822b";
  const char kNewMd5sum[] = "8cbad8c9281e1f3bac2306a5beb1fdcd";
#else
