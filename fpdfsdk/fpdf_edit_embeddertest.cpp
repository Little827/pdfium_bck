...
TEST_F(FPDFEditEmbedderTest, EditOverExistingContent) {
...
#if defined(_SKIA_SUPPORT_) || defined(_SKIA_SUPPORT_PATHS_)
  const char kOriginalMD5[] = "1e82fbdd21490cee9d3479fe6125af67";
#else
  const char kOriginalMD5[] = "ad04e5bd0f471a9a564fb034bd0fb073";
#endif
  ScopedFPDFBitmap bitmap = RenderLoadedPage(page);
  CompareBitmap(bitmap.get(), 612, 792, kOriginalMD5);
  EXPECT_TRUE(FPDFPage_GenerateContent(page));
  ...
  ASSERT_TRUE(OpenSavedDocument());
  FPDF_PAGE saved_page = LoadSavedPage(0);
  VerifySavedRendering(saved_page, 612, 792, kOriginalMD5);
...
#if defined(_SKIA_SUPPORT_) || defined(_SKIA_SUPPORT_PATHS_)
  const char kLastMD5[] = "8705d023e5fec3499d1e30cf2bcc5dc1";
#else
