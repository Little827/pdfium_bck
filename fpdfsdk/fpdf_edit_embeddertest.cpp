...
#if defined(_SKIA_SUPPORT_) || defined(_SKIA_SUPPORT_PATHS_)
#if defined(OS_WIN)
  const char kChecksum[] = "2e5b5d0f0215f83112e40b2a93aa6740";
#else
  const char kChecksum[] = "d72683ec48f7ea0f982ec5761179f515";
#endif  // defined(OS_WIN)
#else
#if defined(OS_WIN)
  const char kChecksum[] = "b5663955358b8aba6504f0fef87ff356";
#elif defined(OS_APPLE)
  const char kChecksum[] = "e638d1e3714c99727a2ca5fde66d19b4";
#else
