...
TEST_F(FPDFEditEmbedderTest, SetTextKeepClippingPath) {
  ...
  static constexpr char kClippedChecksum[] = "ba1936fa8ca1e8cca108da76ff3500a6";
  {
    // When opened before any editing and saving, the clipping path is rendered.
    ScopedFPDFBitmap original_bitmap = RenderPage(page);
    CompareBitmap(original_bitmap.get(), 200, 200, kClippedChecksum);
  }
...

  {
    ...
    CompareBitmap(edited_bitmap.get(), 200, 200, kClippedChecksum);
  }
  ...
  static constexpr char kChangedChecksum[] = "e63e78fcbcfba4b64f2b843fdf2cc3e8";
  {
    // The checksum of |saved_bitmap| should be |kClippedChecksum|.
