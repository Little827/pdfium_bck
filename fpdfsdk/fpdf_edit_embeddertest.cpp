...
using pdfium_testing::kHelloWorldChecksum;
...
TEST_F(FPDFEditEmbedderTest, MAYBE_RemoveLastFromSingleStream) {
  ...
  using pdfium_testing::kHelloWorldRemovedChecksum;
  {
    ScopedFPDFBitmap page_bitmap = RenderPage(page);
...
TEST_F(FPDFEditEmbedderTest, MAYBE_InsertAndRemoveLargeFile) {
  ...
  using pdfium_testing::kManyRectanglesChecksum;
  {
    ScopedFPDFBitmap page_bitmap = RenderPage(page);
...
TEST_F(FPDFEditEmbedderTest, AddAndRemovePaths) {
  ...
  using pdfium_testing::kBlankPage612By792Checksum;
  {
    ScopedFPDFBitmap page_bitmap = RenderPage(page);
