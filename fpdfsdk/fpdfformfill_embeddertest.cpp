...
TEST_F(FPDFFormFillEmbeddertest, FormText) {
...
#endif
  {
    ...
    FPDF_PAGE page = LoadPage(0);
    ASSERT_TRUE(page);
    std::unique_ptr<void, FPDFBitmapDeleter> bitmap1(
        RenderPageDeprecated(page));
    ...
    std::unique_ptr<void, FPDFBitmapDeleter> bitmap2(
        RenderPageDeprecated(page));
    ...
    std::unique_ptr<void, FPDFBitmapDeleter> bitmap3(
        RenderPageDeprecated(page));
