...
FPDF_EXPORT void FPDF_CALLCONV FPDF_ClosePage(FPDF_PAGE page) {
  ...
  // This will delete the corresponding pPageView object. We must cleanup
  // the PageView before releasing the reference on the page as it will
  // attempt to reset the View on the page during destruction.
