...
bool CFFL_CheckBox::OnChar(CPDFSDK_Annot* pAnnot,
  ...
  switch (nChar) {
    ...
    case FWL_VKEY_Space: {
      ...
      CPWL_CheckBox* pWnd = GetOrCreateCheckBox(pPageView);
...
CPWL_CheckBox* CFFL_CheckBox::GetOrCreateCheckBox(CPDFSDK_PageView* pPageView) {
  return static_cast<CPWL_CheckBox*>(GetOrCreatePWLWindow(pPageView));
}
