 ...
 public:
  class Delegate {
   public:
    ...
    virtual void OnSetFieldInputFocus(const WideString& text, bool bFocus) = 0;
  ...
  explicit CFFL_InteractiveFormFiller(Delegate* pDelegate);
  ~CFFL_InteractiveFormFiller() override;

  Delegate* GetDelegate() { return m_pDelegate.Get(); }
