...
bool CFFL_RadioButton::OnChar(CPDFSDK_Annot* pAnnot,
  ...
  switch (nChar) {
    ...
    case FWL_VKEY_Space: {
      ...
      CPWL_RadioButton* pWnd = GetOrCreateRadioButton(pPageView);
...
CPWL_RadioButton* CFFL_RadioButton::GetOrCreateRadioButton(
    CPDFSDK_PageView* pPageView) {
  return static_cast<CPWL_RadioButton*>(GetOrCreatePWLWindow(pPageView));
}
