...
constexpr char kTextFormChecksum[] = "17efe329169f5b7681fbe939894a35de";
#else
#if defined(OS_MACOSX)
constexpr char kTextFormChecksum[] = "d485541d958fef08d24e8eca3e537023";
#elif defined(OS_WIN)
constexpr char kTextFormChecksum[] = "d3204faa62b607f0bd3893c9c22cabcb";
#else
constexpr char kTextFormChecksum[] = "b890950d4b9bc163b1a96797f3004b53";
#endif
...
TEST_F(FPDFFormFillEmbedderTest, FormText) {
#if defined(_SKIA_SUPPORT_) || defined(_SKIA_SUPPORT_PATHS_)
  const char checksum_1[] = "42af2135e20deb09cbdbfb6418d86382";
  const char checksum_2[] = "4a961599a512a08468b26b89d389c30a";
#else
#if defined(OS_MACOSX)
  const char checksum_1[] = "c6e4a2fb10661116771ee74f54d9c5e0";
  const char checksum_2[] = "e0c8d5099301d7c10ed831a43e974d9d";
#elif defined(OS_WIN)
  const char checksum_1[] = "29d1c3fd226ca6a69597f75937690320";
  const char checksum_2[] = "5e678a55912cb568fd677bf34abb8727";
#else
  const char checksum_1[] = "11487d5597599a26e8912b9c1d9422cb";
  const char checksum_2[] = "bffe0ecea9a533f217047ee41d6be466";
#endif
#endif  // defined(_SKIA_SUPPORT_) || defined(_SKIA_SUPPORT_PATHS_)
  {
    ...
    CompareBitmap(bitmap2.get(), 300, 300, checksum_1);
    ...
    CompareBitmap(bitmap3.get(), 300, 300, checksum_1);
    ...
    CompareBitmap(bitmap4.get(), 300, 300, checksum_2);
  ...
  VerifySavedDocument(300, 300, checksum_2);
}
...
TEST_F(FPDFFormFillEmbedderTest, BUG_1281) {
  ...
  CompareBitmap(bitmap_normal.get(), 200, 200, testing::kBug890322Checksum);
