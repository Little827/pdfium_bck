...
TEST_F(FPDFFormFillActionUriTest, LinkKeyboardActionInvokeTest) {
  ...
  EXPECT_EQ(FPDF_FORMFIELD_TEXTFIELD,
            FPDFPage_HasFormFieldAtPoint(form_handle(), page(), 150, 410));

  ASSERT_TRUE(FORM_OnMouseMove(form_handle(), page(), 0, 150, 410));
  ASSERT_TRUE(FORM_OnLButtonDown(form_handle(), page(), 0, 150, 410));
  ASSERT_TRUE(FORM_OnLButtonUp(form_handle(), page(), 0, 150, 410));
