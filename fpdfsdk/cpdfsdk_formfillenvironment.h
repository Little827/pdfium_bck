...
class CPDFSDK_FormFillEnvironment
 ...
 public:
  ...
  CPDFSDK_PageView* GetPageView(CPDF_Page::Handle* pPage, bool renew);
  CPDFSDK_PageView* GetPageView(int nIndex);
  CPDFSDK_PageView* GetCurrentView();
  void RemovePageView(CPDF_Page::Handle* pPage);
  ...
  void Invalidate(CPDF_Page::Handle* page, const FX_RECT& rect);
  void OutputSelectedRect(CPDF_Page::Handle* page, const CFX_FloatRect& rect);
 ...
 private:
  CPDF_Page::Handle* GetPage(int nIndex);

  FPDF_FORMFILLINFO* const m_pInfo;
  std::unique_ptr<CPDFSDK_AnnotHandlerMgr> m_pAnnotHandlerMgr;
  std::unique_ptr<CPDFSDK_ActionHandler> m_pActionHandler;
  std::unique_ptr<IJS_Runtime> m_pIJSRuntime;
  std::map<CPDF_Page::Handle*, std::unique_ptr<CPDFSDK_PageView>> m_PageMap;
