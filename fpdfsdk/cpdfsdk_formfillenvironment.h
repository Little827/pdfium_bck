...
class CPDFSDK_FormFillEnvironment
 ...
 public:
  ...
  CPDFSDK_PageView* GetPageView(IPDF_PageBase* pPage, bool renew);
  CPDFSDK_PageView* GetPageView(int nIndex);
  CPDFSDK_PageView* GetCurrentView();
  void RemovePageView(IPDF_PageBase* pPage);
  ...
  void Invalidate(IPDF_PageBase* page, const FX_RECT& rect);
  void OutputSelectedRect(IPDF_PageBase* page, const CFX_FloatRect& rect);
 ...
 private:
  IPDF_PageBase* GetPage(int nIndex);

  FPDF_FORMFILLINFO* const m_pInfo;
  std::unique_ptr<CPDFSDK_AnnotHandlerMgr> m_pAnnotHandlerMgr;
  std::unique_ptr<CPDFSDK_ActionHandler> m_pActionHandler;
  std::unique_ptr<IJS_Runtime> m_pIJSRuntime;
  std::map<IPDF_PageBase*, std::unique_ptr<CPDFSDK_PageView>> m_PageMap;
