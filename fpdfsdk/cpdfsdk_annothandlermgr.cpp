...
bool CPDFSDK_AnnotHandlerMgr::Annot_SetIndexSelected(CPDFSDK_Annot* pAnnot,
                                                     int index,
                                                     bool selected) {
  return GetAnnotHandler(pAnnot)->SetIndexSelected(pAnnot, index, selected);
}

bool CPDFSDK_AnnotHandlerMgr::Annot_IsIndexSelected(CPDFSDK_Annot* pAnnot,
                                                    int index) {
  return GetAnnotHandler(pAnnot)->IsIndexSelected(pAnnot, index);
}
