...
bool CPDFSDK_AnnotHandlerMgr::Annot_OnKeyUp(CPDFSDK_Annot* annot,
                                            int key_code,
                                            int flag) {
  if (annot && key_code == FWL_VKEY_Return) {
    return GetAnnotHandler(annot)->OnKeyUp(annot, key_code, flag);
  }
