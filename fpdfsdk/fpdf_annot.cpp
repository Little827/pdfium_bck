...
static_assert(static_cast<int>(CPDF_AAction::kNumberOfActions) ==
                  FPDF_ANNOT_AACTION_COUNT,
              "CPDF_AAction::kNumberOfActions value mismatch");
...
FPDFAnnot_GetFormAdditionalActionJavaScript(FPDF_FORMHANDLE hHandle,
  ...
  if (event < 0 || event >= FPDF_ANNOT_AACTION_COUNT)
    return 0;
