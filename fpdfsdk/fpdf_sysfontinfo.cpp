...
class CFX_ExternalFontInfo final : public SystemFontInfoIface {
 public:
  ...
  bool GetFontCharset(void* hFont, FX_CharSet* charset) override {
    ...
    *charset = static_cast<FX_CharSet>(m_pInfo->GetFontCharset(m_pInfo, hFont));
    return true;
  }
...
FPDF_EXPORT void FPDF_CALLCONV FPDF_AddInstalledFont(void* mapper,
  ...
  pMapper->AddInstalledFont(face, static_cast<FX_CharSet>(charset));
}
...
static void* DefaultMapFont(struct _FPDF_SYSFONTINFO* pThis,
                            ...
                            int* bExact) {
  auto* pDefault = static_cast<FPDF_SYSFONTINFO_DEFAULT*>(pThis);
  return pDefault->m_pFontInfo->MapFont(weight, !!bItalic,
                                        static_cast<FX_CharSet>(charset),
                                        pitch_family, family);
}
