...
#ifndef FPDFSDK_XFA_CPDFSDK_XFAWIDGET_H_
#define FPDFSDK_XFA_CPDFSDK_XFAWIDGET_H_
...
inline CPDFSDK_XFAWidget* ToXFAWidget(CPDFSDK_Annot* pAnnot) {
  return pAnnot && pAnnot->GetAnnotSubtype() == CPDF_Annot::Subtype::XFAWIDGET
             ? static_cast<CPDFSDK_XFAWidget*>(pAnnot)
             : nullptr;
}

#endif  // FPDFSDK_XFA_CPDFSDK_XFAWIDGET_H_
