...
void CPWL_EditImpl::SetPlateRect_(const CFX_FloatRect& rect) {
...
void CPWL_EditImpl::SetLimitChar_(int32_t nLimitChar) {
  m_pVT->SetLimitChar(nLimitChar);
}

void CPWL_EditImpl::SetCharArray_(int32_t nCharArray) {
...
void CPWL_EditImpl::SetFontSize_(float fFontSize) {
...
void CPWL_EditImpl::SetText_(const WideString& sText) {
  Clear();
