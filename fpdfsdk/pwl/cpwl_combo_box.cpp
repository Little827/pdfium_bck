...
void CPWL_ComboBox::CreateChildWnd(const CreateParams& cp,
  ...
  CreateEdit(cp, pAttachedData ? pAttachedData->Clone() : nullptr);
  CreateButton(cp, pAttachedData ? pAttachedData->Clone() : nullptr);
  CreateListBox(cp, pAttachedData ? pAttachedData->Clone() : nullptr);
}
...
void CPWL_ComboBox::CreateEdit(const CreateParams& cp,
  ...
  m_pEdit = new CPWL_Edit(std::move(pAttachedData));
...
void CPWL_ComboBox::CreateButton(const CreateParams& cp,
  ...
  // TODO(tsepez): leaks?
  m_pButton = new CPWL_CBButton(std::move(pAttachedData));
...
void CPWL_ComboBox::CreateListBox(const CreateParams& cp,
  ...
  //  TODO(tsepez): leaks?
  m_pList = new CPWL_CBListBox(std::move(pAttachedData));
