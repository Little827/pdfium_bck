...
class CPWL_EditImpl {
 public:
  ...
  void SetPlateRect_(const CFX_FloatRect& rect);
  ...
  void SetLimitChar_(int32_t nLimitChar);
  void SetCharArray_(int32_t nCharArray);
  void SetCharSpace(float fCharSpace);
  void SetMultiLine(bool bMultiLine);
  void SetAutoReturn(bool bAuto);
  void SetAutoFontSize(bool bAuto);
  void SetAutoScroll(bool bAuto);
  void SetFontSize_(float fFontSize);
  ...
  void SetText_(const WideString& sText);
