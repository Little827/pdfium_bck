...
class CPWL_EditImpl {
 ...
 private:
  ...
  class UndoInsertWord final : public UndoItemIface {
   public:
  ...
  class UndoInsertReturn final : public UndoItemIface {
   public:
  ...
  class UndoReplaceSelection final : public UndoItemIface {
   public:
  ...
  class UndoBackspace final : public UndoItemIface {
   public:
  ...
  class UndoDelete final : public UndoItemIface {
   public:
  ...
  class UndoClear final : public UndoItemIface {
   public:
  ...
  class UndoInsertText final : public UndoItemIface {
   public:
  ...
  class Provider final : public CPVT_VariableText::Provider {
   public:
