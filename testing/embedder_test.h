...
class EmbedderTest : public ::testing::Test,
 ...
 public:
  ...
  UniqueFPDFBitmap RenderLoadedPage(FPDF_PAGE page);
  ...
  UniqueFPDFBitmap RenderLoadedPageWithFlags(FPDF_PAGE page, int flags);

  // RenderSavedPageWithFlags() with no flags.
  UniqueFPDFBitmap RenderSavedPage(FPDF_PAGE page);

  // Convert |page| loaded via LoadSavedPage() into a bitmap with the specified
  // page rendering |flags|.
  //
  // See public/fpdfview.h for a list of page rendering flags.
  UniqueFPDFBitmap RenderSavedPageWithFlags(FPDF_PAGE page, int flags);
  ...
  static UniqueFPDFBitmap RenderPageWithFlags(FPDF_PAGE page,
