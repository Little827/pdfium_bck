...
class EmbedderTest : public ::testing::Test,
 ...
 public:
  ...
  // StartRenderLoadedPageWithFlags() with no flags.
  // The call returns true if the rendering is complete.
  bool StartRenderLoadedPage(FPDF_PAGE page, IFSDK_PAUSE* pause);
  ...
  // Start rendering of |page| loaded via LoadPage() into a bitmap with the
  // ability to pause the rendering with the specified rendering |flags|.
  // The call returns true if the rendering is complete.
  //
  // See public/fpdfview.h for a list of page rendering flags.
  bool StartRenderLoadedPageWithFlags(FPDF_PAGE page,
                                      IFSDK_PAUSE* pause,
                                      int flags);
 ...
 protected:
  ...
  // FPDF_RenderPage_Close() is called after which the bitmap is sent to the
  // caller.
