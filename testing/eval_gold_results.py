...
# Load the passfail.json file from all the output directories and print
...
def main(result_dirs):
  ...
  for result_dir in result_dirs:
    # Load the json data from the output directory.
...
if __name__=='__main__':
  if len(sys.argv) <= 1:
    print 'Error: At least one output directory is required as argument. ' + \
          'Received none!\n'
    print 'Usage:'
