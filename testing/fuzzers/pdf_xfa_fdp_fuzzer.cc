 ...
 public:
  ...
  void FormActionHandler(FPDF_FORMHANDLE form,
    ...
    for (int i = 0; i < number_of_calls; i++) {
      ...
      switch (selector) {
        case kOnLButtonUp: {
          FORM_OnLButtonUp(form, page, 0,
                           fdp_->ConsumeIntegralInRange<int>(-500, 5000),
                           fdp_->ConsumeIntegralInRange<int>(-500, 5000));
          break;
        }
        case kOnRButtonUp: {
          FORM_OnRButtonUp(form, page, 0,
                           fdp_->ConsumeIntegralInRange<int>(-500, 5000),
                           fdp_->ConsumeIntegralInRange<int>(-500, 5000));
          break;
        }
        case kOnLButtonDown: {
          FORM_OnLButtonDown(form, page, 0,
                             fdp_->ConsumeIntegralInRange<int>(-500, 5000),
                             fdp_->ConsumeIntegralInRange<int>(-500, 5000));
          break;
        }
        case kOnRButtonDown: {
          FORM_OnRButtonDown(form, page, 0,
                             fdp_->ConsumeIntegralInRange<int>(-500, 5000),
                             fdp_->ConsumeIntegralInRange<int>(-500, 5000));
          break;
        }
        case kOnChar: {
          FORM_OnChar(form, page, fdp_->ConsumeIntegral<int>(), 0);
          break;
        }
        case kOnKeyDown: {
        ...
        case kOnMouseMove: {
          FORM_OnMouseMove(form, page, 0, fdp_->ConsumeIntegral<int>(),
                           fdp_->ConsumeIntegral<int>());
          break;
        }
        case kOnMouseWheel: {
        ...
        case kOnFocus: {
          FORM_OnFocus(form, page, 0, fdp_->ConsumeIntegral<int>(),
                       fdp_->ConsumeIntegral<int>());
          break;
        }
        case kUndo: {
