...
std::string GenXfaScriptFuncName(FuzzedDataProvider* data_provider) {
  static const char* kXfaScriptFuncs[] = {
      "Abs",       "Apr",        "At",           "Avg",          "Ceil",
  ...
  size_t elem_selector = data_provider->ConsumeIntegralInRange<size_t>(
      0, sizeof(kXfaScriptFuncs) / sizeof(kXfaScriptFuncs[0]) - 1);
...
std::string GenXfaScriptParam(FuzzedDataProvider* data_provider) {
  static const char* kXfaFuncParams[] = {
      "$",
      "-0",
      "04/13/2019",
      ".05",
  ...
  size_t elem_selector = data_provider->ConsumeIntegralInRange<size_t>(
      0, sizeof(kXfaFuncParams) / sizeof(kXfaFuncParams[0]));
  std::string xfa_string = kXfaFuncParams[elem_selector];
...
std::string GenXfaTag(FuzzedDataProvider* data_provider) {
  static const char* kXfaElemTags[] = {
      "accessibleContent",
      "acrobat",
      "acrobat",
      "acrobat7",
  ...
  size_t elem_selector = data_provider->ConsumeIntegralInRange<size_t>(
      0, sizeof(kXfaElemTags) / sizeof(kXfaElemTags[0]) - 1);
...
std::string GenXfaTagValue(FuzzedDataProvider* data_provider) {
  ...
  size_t elem_selector = data_provider->ConsumeIntegralInRange<size_t>(
      0, sizeof(kXfaTagVals) / sizeof(kXfaTagVals[0]) - 1);
  std::string xfa_string = kXfaTagVals[elem_selector];
...
std::string GenXfaTagName(FuzzedDataProvider* data_provider) {
  static const char* kXfaTagNames[] = {
  ...
  size_t elem_selector = data_provider->ConsumeIntegralInRange<size_t>(
      0, sizeof(kXfaTagNames) / sizeof(kXfaTagNames[0]) - 1);
