...
std::string GenXDPPdfFile(FuzzedDataProvider* data_provider) {
  ...
  size_t xref_3 = xref_2 + obj2.size();
...
0 10
  ...
  xref += GenXrefEntry(xref_0);
  xref += GenXrefEntry(xref_1);
  xref += GenXrefEntry(xref_2);
  xref += GenXrefEntry(xref_3);
  xref += GenXrefEntry(xref_4);
  xref += GenXrefEntry(xref_5);
  xref += GenXrefEntry(xref_6);
  xref += GenXrefEntry(xref_7);
  xref += GenXrefEntry(xref_8);
  xref += GenXrefEntry(xref_9);
