...
class TestRunner:
  ...
  def _PrintSummary(self):
    ...
    if self.test_type not in TEXT_TESTS:
      ...
      number_total_gold_tests = sum([number_gold_failures, number_gold_successes,number_gold_surprises])
      ...
      if self.skia_gold_failures:
        print self.skia_tester.GetTriageLink(self.skia_gold_failures[0])
    print
