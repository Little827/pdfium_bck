...
class TestRunner:
  ...
  def GetSkiaTester(self):
    if not self.skia_tester:
      self.skia_tester = gold.SkiaTester(
  ...
  def HandleResult(self, input_filename, input_path, result):
    ...
    if image_paths and self.test_type not in TEXT_TESTS:
      ...
      for img_path, _ in image_paths:
        ...
        self.GetSkiaTester().UploadTestResultToSkiaGold(test_name, img_path)
          ...
          if input_file_re.match(input_filename):
            ...
            if self.test_suppressor.IsExecutionSuppressed(input_path):
              ...
              if os.path.isfile(input_path):
                  if 'bug_1012369' in input_filename:
      ...
      try:
        ...
        for worker_result in worker_results:
          ...
          if self.test_type not in TEXT_TESTS:
            self.GetSkiaTester().UploadTestResultToSkiaGold(input_filename, )
