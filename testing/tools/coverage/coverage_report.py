...
Requires that 'is_component_build = false' is set in args.gn.
"""
...
class CoverageExecutor(object):
  ...
  def __init__(self, parser, args):
    ...
    if GetBooleanGnArg('is_component_build', self.build_directory,
                       self.verbose):
      parser.error(
          'is_component_build appears to be set to true, but needs to be false')
  ...
  def generate_html_report(self):
    ...
    coverage_args += ['-o', self.output_directory]
