...
def main():
  ...
  deps_revision = _GetDepsRevision(deps_path)

  buildtools_deps_path = sys.argv[2]
  buildtools_revision = _GetBuildtoolsDepsRevision(buildtools_deps_path)
